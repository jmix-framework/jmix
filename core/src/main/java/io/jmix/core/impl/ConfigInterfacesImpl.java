...
import io.jmix.core.config.ConfigHandler;
...
/**
 * Server-side implementation of the {@link ConfigInterfaces} interface.
 */
@Component(ConfigInterfaces.NAME)
public class ConfigInterfacesImpl implements ConfigInterfaces, BeanFactoryPostProcessor, ApplicationContextAware {
