...
public class JmixDeleteQuery extends JmixListQuery {
    ...
    public JmixDeleteQuery(UnconstrainedDataManager dataManager, Metadata jmixMetadata, Method method, RepositoryMetadata metadata, ProjectionFactory factory, PartTree qryTree) {
