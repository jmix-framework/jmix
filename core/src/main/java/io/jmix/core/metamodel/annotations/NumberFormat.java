...
public @interface NumberFormat {
	...
	/**
	 * Decimal separator. If not specified, will be obtained from {@link io.jmix.core.metamodel.datatypes.FormatStrings}
     * for locale-dependent formatting, or from server default locale for locale-independent formatting.
	 */
	String decimalSeparator() default "";

    /**
   	 * Grouping separator. If not specified, will be obtained from {@link io.jmix.core.metamodel.datatypes.FormatStrings}
     * for locale-dependent formatting, or from server default locale for locale-independent formatting.
   	 */
