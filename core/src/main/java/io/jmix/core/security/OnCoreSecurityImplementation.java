 ...
 * for registration when "core" security implementation is selected.
 */
public class OnCoreSecurityImplementation extends AbstractSecurityImplementationCondition {
