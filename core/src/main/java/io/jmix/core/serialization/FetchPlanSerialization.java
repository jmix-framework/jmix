...
/**
 */
@Component(FetchPlanSerializationAPI.NAME)
public class FetchPlanSerialization implements FetchPlanSerializationAPI {

    @Inject
    protected Metadata metadata;

    private static final Logger log = LoggerFactory.getLogger(FetchPlanSerialization.class);
    ...
    @Override
    public String toJson(FetchPlan view, FetchPlanSerializationOption... options) {
