...
/**
 * Describes special window parameters that are set by system mechanisms such as {@code WindowManager}.
...
public enum WindowParams {
    ...
    /**
     * Entity instance which is passed to an editor's controller <code>init</code> method from {@code WindowManager}.
     */
    ITEM,
