...
public class ConditionDescriptorsDs extends AbstractTreeDatasource<AbstractConditionDescriptor, UUID> {
    ...
    @Override
    protected Tree<AbstractConditionDescriptor> loadTree(Map params) {
        //noinspection unchecked
        descriptorsTree = (Tree<AbstractConditionDescriptor>) params.get("descriptorsTree");
    ...
    public void setFilter(String filter) {
        ...
        filterApplied = true;
        refresh(Collections.singletonMap("descriptorsTree", descriptorsTree));
    }
