...
@JmixEntity(name = "sec$CustomCondition")
@SystemLevel
public class CustomCondition extends AbstractCondition {
    ...
    public CustomCondition(Element element, String messagesPack, String filterComponentName, io.jmix.core.metamodel.model.MetaClass metaClass) {
