...
public class HierarchicalPropertyDatasourceImpl<T extends JmixEntity, K>
    ...
    public Collection<K> getChildren(K itemId) {
        if (hierarchyPropertyName != null) {
            ...
            for (K id : ids) {
                JmixEntity currentItem = getItemNN(id);
            ...
            if (StringUtils.isNotBlank(sortPropertyName)) {
                res.sort((o1, o2) -> {
                    JmixEntity item1 = getItemNN(o1);
                    JmixEntity item2 = getItemNN(o2);
    ...
    public K getParent(K itemId) {
        if (hierarchyPropertyName != null) {
            ...
            if (item == null)
                ...
                JmixEntity value = EntityValues.getValue(item, hierarchyPropertyName);
    ...
    public boolean hasChildren(K itemId) {
        final JmixEntity item = getItem(itemId);
        if (item == null) return false;
