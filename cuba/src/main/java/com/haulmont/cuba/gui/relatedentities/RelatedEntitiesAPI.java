...
public interface RelatedEntitiesAPI {
     ...
     */
    @Deprecated
    default void openRelatedScreen(Collection<? extends Entity> selectedEntities,
     ...
     */
    @Deprecated
    default <T extends Entity> void openRelatedScreen(Collection<T> selectedEntities, Class<T> clazz, String property) {
