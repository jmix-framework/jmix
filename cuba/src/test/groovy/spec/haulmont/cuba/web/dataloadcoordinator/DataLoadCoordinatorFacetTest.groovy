...
import spec.haulmont.cuba.web.dataloadcoordinator.screens.DlcAutoWithFragmentScreen
...
class DataLoadCoordinatorFacetTest extends UiScreenSpec {
    ...
    def setup() {
        exportScreensPackages(['spec.haulmont.cuba.web.dataloadcoordinator.screens', 'com.haulmont.cuba.web.app.main'])
    }
