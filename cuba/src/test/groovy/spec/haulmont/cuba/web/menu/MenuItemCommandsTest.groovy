...
import spec.haulmont.cuba.web.menu.commandtargets.PropertiesInjectionTestScreen
import spec.haulmont.cuba.web.menu.commandtargets.TestMenuItemConsumer
import spec.haulmont.cuba.web.menu.commandtargets.TestMenuItemRunnable
import spec.haulmont.cuba.web.menu.commandtargets.TestRunnable
...
class MenuItemCommandsTest extends UiScreenSpec {
    ...
    /*@SuppressWarnings('GroovyAccessibility') todo port
