...
//public class OrmDataStore1 extends AbstractDataStore implements DataStore, DataSortingOptions {
//
//    public static final String LOAD_TX_PREFIX = "OrmDataStore-load-";
//    public static final String SAVE_TX_PREFIX = "OrmDataStore-save-";
//
//    private static final Logger log = LoggerFactory.getLogger(OrmDataStore1.class);
//
//    @Autowired
...
//        if (ormLifecycleListeners != null) {
//            for (JpaLifecycleListener lifecycleListener : ormLifecycleListeners) {
