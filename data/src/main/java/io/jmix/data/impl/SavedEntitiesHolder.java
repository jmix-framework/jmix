...
public class SavedEntitiesHolder extends ResourceHolderSupport {
    ...
    public static SavedEntitiesHolder setEntities(Collection<Object> saved) {
    ...
    public Set<Object> getEntities(Collection<Object> saved) {
        Set<Object> result = new HashSet<>(entities);
