...
package io.jmix.data.repositories.config;


import io.jmix.data.repositories.support.JmixJpaRepositoryImpl;
import io.jmix.data.repositories.support.JmixRepositoryFactoryBean;
...
public @interface EnableJmixRepositories {
     ...
     */
    Class<?> repositoryBaseClass() default JmixJpaRepositoryImpl.class;
