...
public abstract class ConditionQuery extends JmixAbstractQuery {
    protected Condition conditions;
    protected boolean distinct;
    protected Integer maxResults = null;

    public ConditionQuery(DataManager dataManager, Metadata jmixMetadata, Method method, RepositoryMetadata metadata, ProjectionFactory factory, PartTree qryTree) {
