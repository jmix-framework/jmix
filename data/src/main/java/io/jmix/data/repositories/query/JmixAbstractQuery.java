...
public abstract class JmixAbstractQuery implements RepositoryQuery {
    ...
    protected Map<String, Integer> namedParametersBindings = null;
    ...
    private void setFetchPlan(Method method) {
        FetchPlan viewAnnotation = method.getDeclaredAnnotation(FetchPlan.class);
        if (viewAnnotation != null) {
            fetchPlan = viewAnnotation.value();
        }
    }
