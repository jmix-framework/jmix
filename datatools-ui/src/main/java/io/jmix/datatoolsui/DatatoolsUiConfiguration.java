...
public class DatatoolsUiConfiguration {
    ...
    public UiControllersConfiguration screens(ApplicationContext applicationContext,
        ...
        uiControllers.setBasePackages(Collections.singletonList("io.jmix.datatoolsui"));
    ...
    public ActionsConfiguration actions(ApplicationContext applicationContext,
        ...
        actionsConfiguration.setBasePackages(Collections.singletonList("io.jmix.datatoolsui.action"));
