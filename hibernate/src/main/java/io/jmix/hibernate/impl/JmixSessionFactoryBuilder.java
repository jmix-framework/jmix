...
import io.jmix.hibernate.impl.metadata.CompositeMetadataEnhancer;
...
public class JmixSessionFactoryBuilder extends AbstractDelegatingSessionFactoryBuilderImplementor<JmixSessionFactoryBuilder> {
    ...
    public SessionFactory build() {
        ...
        CompositeMetadataEnhancer metadataEnhancer = beanFactory.getBean(CompositeMetadataEnhancer.class);
        metadataEnhancer.enhance(metadata);
