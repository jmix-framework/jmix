...
import test_support.HibernateTestConfiguration
import test_support_modules.addon.TestAddonConfiguration
import test_support_modules.app.TestAppConfiguration

@ContextConfiguration(classes = [
        CoreConfiguration, DataConfiguration, HibernateConfiguration, HibernateTestConfiguration, TestAddonConfiguration, TestAppConfiguration])
