...
package io.jmix.aitoolsflowui.view.aiconversation.composer;
 ...
 * the timeline ({@code AiConversationFragment}) and on the chat starter screen.
 * <p>
 ...
 * <p>
 * The fragment is UI-only: it hands the trimmed, non-blank text to the
 * {@link #setSubmitHandler(Consumer) submit handler} and never starts a
 * conversation itself.
 */
