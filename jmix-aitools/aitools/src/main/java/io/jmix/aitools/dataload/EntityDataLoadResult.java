...
public class EntityDataLoadResult {
    ...
    /**
     * Returns the query as generated by the LLM, before any validation repair: JPQL, parameters,
     * result-property names, explanation and warnings. If the query was repaired during execution,
     * the executed query may differ — only this original version is exposed here.
     *
     * @return the LLM-generated query, before any repair
     */
