...
public interface RegisteredClientRoleAssignmentRepository {
    ...
    Collection<RegisteredClientRoleAssignment> findByClientId(String clientId);

    Collection<RegisteredClientRoleAssignment> findByRegistrationId(String registrationId);
}