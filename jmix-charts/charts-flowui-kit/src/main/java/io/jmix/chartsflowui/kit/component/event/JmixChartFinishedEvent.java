...
import io.jmix.chartsflowui.kit.component.event.dto.JmixFinishedEventDetail;


@DomEvent(JmixChartFinishedEvent.EVENT_NAME)
public class JmixChartFinishedEvent extends JmixChartEvent implements JmixChartDetailEvent<JmixFinishedEventDetail> {
