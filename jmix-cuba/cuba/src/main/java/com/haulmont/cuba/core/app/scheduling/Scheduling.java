...
public class Scheduling implements SchedulingAPI {
    ...
    public boolean isActive() {
        try {
            return configuration.getConfig(SchedulingConfig.class).getSchedulingActive();
        } catch (Exception e) {
    ...
    public void setActive(boolean value) {
        configuration.getConfig(SchedulingConfig.class).setSchedulingActive(value);
    }
    ...
    protected long getSchedulingInterval() {
        return configuration.getConfig(SchedulingConfig.class).getSchedulingInterval();
    }
    ...
    public void runOnce(ScheduledTask task) {
        ...
        runner.runTaskOnce(task, timeSource.currentTimeMillis());
    }
