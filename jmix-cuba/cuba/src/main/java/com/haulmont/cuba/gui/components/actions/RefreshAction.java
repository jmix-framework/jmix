...
public class RefreshAction extends BaseAction {
    ...
    /**
     * @return  parameters for {@link CollectionDatasource#refresh(Map)} method
     */
    ...
    /**
     * @param refreshParams parameters for {@link CollectionDatasource#refresh(Map)} method
     */
    ...
    /**
     * @return supplier that provides parameters for {@link CollectionDatasource#refresh(Map)} method
     */
    ...
    /**
     * @param refreshParamsSupplier supplier that provides parameters for {@link CollectionDatasource#refresh(Map)} method
     */
