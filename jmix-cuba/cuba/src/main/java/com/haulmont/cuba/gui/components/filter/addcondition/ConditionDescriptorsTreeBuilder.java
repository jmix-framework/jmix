...
/**
 * Builds a {@link Tree} of {@link AbstractConditionDescriptor}. These
...
public class ConditionDescriptorsTreeBuilder implements ConditionDescriptorsTreeBuilderAPI {
    ...
    // protected DynamicAttributes dynamicAttributes; todo dynamic attributes
    ...
    protected String getFilterComponentName() {
        String filterComponentName = CubaComponentsHelper.getFilterComponentPath(filter);
