...
public class PropertyCondition extends AbstractCondition {
    ...
    public PropertyCondition(Element element, String messagesPack, String filterComponentName, io.jmix.core.metamodel.model.MetaClass metaClass) {
    ...
    protected void updateText() {
        ...
        String path = (metaClass instanceof KeyValueMetaClass
                && Strings.isNullOrEmpty(propertiesPath)) ?
                entityAlias :
