...
import io.jmix.ui.xml.layout.loader.CheckBoxLoader;
import org.dom4j.Element;

public class CubaCheckBoxLoader extends CheckBoxLoader {

    @Override
    public void createComponent() {
        UiComponents uiComponents = applicationContext.getBean(UiComponents.class);
        resultComponent = uiComponents.create(CheckBox.NAME);
    ...
    @Override
    protected void loadData(io.jmix.ui.component.CheckBox component, Element element) {
