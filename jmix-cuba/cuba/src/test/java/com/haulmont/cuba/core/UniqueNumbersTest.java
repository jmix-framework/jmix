...
public class UniqueNumbersTest {
    ...
    @Test
    public void test() {
        long n = uniqueNumbersAPI.getNextNumber("test1");
        assertTrue(n >= 0);
    }
    ...
    protected class GetNumberAction extends Action {
        ...
        public int perform(int threadNumber) {
            ...
            long nextNumber = uniqueNumbersAPI.getNextNumber(seqNames[nextInt]);
            return nextInt;
        }
    ...
    protected class SetNumberAction extends Action {
        ...
        public int perform(int threadNumber) {
            ...
            uniqueNumbersAPI.setCurrentNumber(seqNames[nextInt], nextNum);
            return nextInt;
        }
    ...
    protected class DeleteSequenceAction extends Action {
        ...
        public int perform(int threadNumber) {
            ThreadLocalRandom random = ThreadLocalRandom.current();
            int nextInt = random.nextInt(0, 3);
            uniqueNumbersAPI.deleteSequence(seqNames[nextInt]);
            return nextInt;
        }
