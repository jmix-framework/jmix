...
@Component("h2DbmsFeatures")
public class H2DbmsFeatures implements DbmsFeatures {

    @Override
    public Map<String, String> getJpaParameters() {
        HashMap<String, String> params = new HashMap<>();
        params.put("eclipselink.target-database", "io.jmix.eclipselink.impl.dbms.JmixH2Platform");
        return params;
    }
    ...
    public String getUniqueConstraintViolationPattern() {
        return "Unique index or primary key violation: \"[^.\"]+\\.([^\\s]+)";
    }
