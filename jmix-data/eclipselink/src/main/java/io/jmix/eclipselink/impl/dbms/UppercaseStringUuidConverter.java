...
public class UppercaseStringUuidConverter implements Converter {

    private final static UppercaseStringUuidConverter INSTANCE = new UppercaseStringUuidConverter();

    public static UppercaseStringUuidConverter getInstance() {
        return INSTANCE;
    }
