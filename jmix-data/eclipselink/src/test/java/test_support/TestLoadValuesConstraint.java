...
@Component("test_LoadValuesConstraint")
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class TestLoadValuesConstraint implements EntityOperationConstraint<LoadValuesAccessContext> {
    ...
    public void applyTo(LoadValuesAccessContext context) {
        context.getEntityClasses();
        context.getAllPropertyPaths();
        context.getSelectedPropertyPaths();
    }
}
