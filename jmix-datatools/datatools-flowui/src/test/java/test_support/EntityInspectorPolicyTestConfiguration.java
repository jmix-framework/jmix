...
@JmixModule(dependsOn = {SecurityDataConfiguration.class, EclipselinkConfiguration.class, SecurityConfiguration.class})
@Import(EntityInspectorPolicyTestConfiguration.TestStandardSecurityConfiguration.class)
...
public class EntityInspectorPolicyTestConfiguration {
    ...
    DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:hsqldb:mem:datatoolsflowui-testdb");
