...
class EmailRefreshTokenManagerTest {
    ...
    @Test
    void testBlankInitialValueIsIgnored() {
        EmailRefreshTokenManagerImpl manager = managerWithoutStoredToken("");
        assertThrows(IllegalStateException.class, manager::getRefreshTokenValue);
    }
