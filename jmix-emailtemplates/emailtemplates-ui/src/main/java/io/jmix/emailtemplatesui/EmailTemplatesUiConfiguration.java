...
package io.jmix.emailtemplatesui;
...
@Configuration
@ComponentScan
@JmixModule(dependsOn = {EmailTemplatesConfiguration.class, UiConfiguration.class})
...
public class EmailTemplatesUiConfiguration {
    ...
    public UiControllersConfiguration screens(ApplicationContext applicationContext,
        ...
        uiControllers.setBasePackages(Collections.singletonList("io.jmix.emailtemplatesui"));
