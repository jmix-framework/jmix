...
public class GenericFilterSaveAsAction<A extends GenericFilterAction<A>> extends GenericFilterAction<A> {
    ...
    protected void initInputDialogFormFields(FormLayout formLayout) {
        ...
        generatedIdField.getParent()
                .ifPresent(formItem -> formItem.setVisible(flowuiComponentProperties.isFilterShowConfigurationIdField()));
        idField.getParent()
                .ifPresent(formItem -> formItem.setVisible(flowuiComponentProperties.isFilterShowConfigurationIdField()));
    }
