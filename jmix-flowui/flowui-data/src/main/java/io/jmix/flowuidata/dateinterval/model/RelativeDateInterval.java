...
public class RelativeDateInterval implements BaseDateInterval {
    ...
    public RelativeDateInterval(Operation operation, String relativeDateMomentName) {
    ...
    public enum Operation {
        ...
        public static Operation fromValue(String value) {
            ...
            throw new IllegalArgumentException(String.format("There is no Operation for the value: '%s'", value));
        }
    }
}
