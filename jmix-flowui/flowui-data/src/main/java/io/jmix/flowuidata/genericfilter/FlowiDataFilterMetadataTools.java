...
@Internal
public class FlowiDataFilterMetadataTools extends FilterMetadataTools {
    ...
    public FlowiDataFilterMetadataTools(MetadataTools metadataTools,
                                        FlowuiComponentProperties flowuiComponentProperties,
                                        AccessManager accessManager,
                                        QueryTransformerFactory queryTransformerFactory,
                                        Metadata metadata) {
        super(metadataTools, flowuiComponentProperties, accessManager, metadata);
