...
@Route(value = "FacetManualTestView", layout = TestMainView.class)
@ViewController
@ViewDescriptor("facet-manual-test-view.xml")
public class FacetManualTestView extends StandardView {
