...
/**
 * Replaces {@code com.vaadin.base.devserver.FileWatcher} of {@code vaadin-dev-server}
 * (shadowed by this class in the {@code jmix-flowui-devserver} jar) to keep the dev server off JNA.
 * <p>
 * <p>
 * See also related <a href="https://github.com/jmix-framework/jmix/issues/4482">issue</a>
 *
 * @see io.jmix.flowui.devserver.theme.ThemeFilesSynchronizer
 */
public class FileWatcher {
    ...
    private static final ExecutorService executorService = Executors
            .newCachedThreadPool(new NamedDaemonThreadFactory("vaadin-file-watcher"));
     ...
     * @param watchDirectory   the directory to watch for changes, cannot be empty
     * @throws IOException if an error occurs while setting up the watcher
     */
    public FileWatcher(SerializableConsumer<File> onChangeConsumer,
        ...
        watcher = DirectoryWatcher.builder()
                .path(watchDirectory.toPath())
                // this line fix the issue with JNA
                .watchService(FileSystems.getDefault().newWatchService())
                .listener(e -> onChangeConsumer.accept(e.path().toFile()))
                .build();
    }
     ...
     *
     * @throws IOException if an error occurs during stop
     */
