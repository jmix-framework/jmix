...
public interface EndpointGeneratorTaskFactory {
     ...
     * @param openApi               openApi json file. not {@code null}
     * @param outputFolder          the output folder. not {@code null}
     * @param frontendDirectory     the frontend folder.
     ...
     * @param javaSourceFolder source paths of the project containing Vaadin Endpoint. not
     *                         {@code null}
     * @param classLoader      The class loader which should be used to resolved types in the
     *                         source paths. not {@code null}
     * @param output           the output path of the generated json file. not {@code null}
