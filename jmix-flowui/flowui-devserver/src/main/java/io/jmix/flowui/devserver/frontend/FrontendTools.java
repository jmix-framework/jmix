...
public class FrontendTools {
    ...
    private static FrontendToolsSettings createSettings(
        ...
        final String nodeVersion = applicationConfiguration.getStringProperty(
                NODE_VERSION, com.vaadin.flow.server.frontend.FrontendTools.DEFAULT_NODE_VERSION);
    ...
    private Logger getLogger() {
        return LoggerFactory.getLogger(com.vaadin.flow.server.frontend.FrontendTools.class);
    }
