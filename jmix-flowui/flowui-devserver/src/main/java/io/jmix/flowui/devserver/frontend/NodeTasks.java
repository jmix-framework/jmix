...
public class NodeTasks implements FallibleCommand {
    ...
    public static class Builder implements Serializable {
         ...
         * jars.
         *
         * @param flowResourcesFolder target folder
         * @return the builder
         */
        ...
        public Builder withThemeValue(String themeValue) {
        ...
        public Builder withThemeVariant(String themeVariant) {
        ...
        public Builder withThemeClass(String themeClass) {
        ...
        public Builder withStudioFolder(File studioFolder) {
         ...
         * @return the builder, for chaining
         */
        public Builder copyLocalThemes(File localThemeFolder) {
    ...
    private ThemeDefinition createThemeDefinition(Builder builder, ClassFinder classFinder) {
        if (builder.themeClass == null) {
            return null;
        }

        Class<? extends AbstractTheme> themeClass = getThemeClass(classFinder, builder.themeClass);
        return new ThemeDefinition(themeClass, builder.themeVariant, builder.themeValue);
    }
    ...
    private NodeTasks(Builder builder) {
        ...
        ThemeDefinition themeDefinition = createThemeDefinition(builder, classFinder);
        ...
        if (builder.enablePackagesUpdate || builder.enableImportsUpdate
            ...
            if (builder.enablePackagesUpdate
                ...
                packageUpdater = new TaskUpdatePackages(classFinder,
                        frontendDependencies, builder.npmFolder, builder.studioFolder,
        ...
        if (builder.createMissingPackageJson) {
            TaskGeneratePackageJson packageCreator = new TaskGeneratePackageJson(
                    builder.npmFolder, builder.studioFolder, builder.generatedFolder,
        ...
        if (!builder.useLegacyV14Bootstrap) {
            ...
            commands.add(new TaskGenerateBootstrap(frontendDependencies,
                    builder.frontendDirectory, builder.productionMode, themeDefinition));
        ...
        if (builder.frontendDirectory != null
                && builder.localThemeFolder != null) {
            commands.add(new TaskCopyLocalThemeFiles(
                    new File(builder.frontendDirectory, "themes"), builder.localThemeFolder));
        }

        if (false/*featureFlags.isEnabled(FeatureFlags.VITE)*/) {
            String themeName = "";
            ...
            commands.add(new TaskUpdateVite(builder.studioFolder,
            ...
            commands.add(new TaskUpdateWebpack(builder.frontendDirectory,
                    ...
                    builder.webappResourcesDirectory,
        ...
        if (builder.enableImportsUpdate) {
            commands.add(new TaskUpdateImports(classFinder,
                    ...
                    builder.useLegacyV14Bootstrap, featureFlags, themeDefinition));

            commands.add(new TaskUpdateThemeImport(builder.studioFolder,
                    themeDefinition,
    ...
    private void addBootstrapTasks(Builder builder) {
        ...
        if (false /*builder.getFeatureFlags().isEnabled(FeatureFlags.VITE)*/
    ...
    private void addGenerateTsConfigTask(Builder builder) {
        TaskGenerateTsConfig taskGenerateTsConfig = new TaskGenerateTsConfig(builder.studioFolder);
        commands.add(taskGenerateTsConfig);

        TaskGenerateTsDefinitions taskGenerateTsDefinitions = new TaskGenerateTsDefinitions(builder.studioFolder);
