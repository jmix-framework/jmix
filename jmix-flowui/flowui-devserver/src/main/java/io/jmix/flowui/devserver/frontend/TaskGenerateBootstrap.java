...
public class TaskGenerateBootstrap extends AbstractTaskClientGenerator {
    ...
    protected String getFileContent() {
        ...
        lines.add(String.format("import './%s';%n", FrontendUtils.FEATURE_FLAGS_FILE_NAME));
    ...
    protected File getGeneratedFile() {
        return new File(frontendGeneratedDirectory, FrontendUtils.BOOTSTRAP_FILE_NAME);
    }
    ...
    private String getIndexTsEntryPath() {
        boolean hasCustomIndexFile = new File(frontendDirectory, FrontendUtils.INDEX_TS)
                .exists() || new File(frontendDirectory, FrontendUtils.INDEX_JS).exists();
