...
import static io.jmix.flowui.devserver.frontend.FileIOUtils.compareIgnoringIndentationEOLAndWhiteSpace;
...
public class TaskGenerateTsDefinitions extends AbstractTaskClientGenerator {
    ...
    protected boolean shouldGenerate() {
        ...
        return !tsDefinitionsFile.exists() && new File(options.getStudioFolder(),
    ...
    private String getTemplateContent(String suffix) throws IOException {
        try (InputStream tsDefinitionStream = FrontendUtils.getResourceAsStream(TS_DEFINITIONS + suffix)) {
