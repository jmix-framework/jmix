...
public class TaskGenerateViteDevMode extends AbstractTaskClientGenerator {
    ...
    protected File getGeneratedFile() {
        return new File(new File(frontendDirectory, FrontendUtils.GENERATED), FrontendUtils.VITE_DEVMODE_TS);
    }
    ...
    protected String getFileContent() throws IOException {
        try (InputStream devModeStream = FrontendUtils.getResourceAsStream(
                FrontendUtils.VITE_DEVMODE_TS, TaskGenerateViteDevMode.class.getClassLoader()
        )) {
