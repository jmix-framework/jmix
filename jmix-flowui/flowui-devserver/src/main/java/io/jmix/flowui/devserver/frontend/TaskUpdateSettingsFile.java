...
public class TaskUpdateSettingsFile implements FallibleCommand, Serializable {
    ...
    public void execute() {
        ...
        settings.put("themeResourceFolder", FrontendUtils.getUnixPath(generatedFolder.toPath()));
        ...
        settings.put("addonFrontendFolder", combinePath(buildDirectory, FrontendUtils.DEFAULT_FLOW_RESOURCES_FOLDER));
    ...
    private String getServiceWorkerFile() {
        boolean exists = new File(frontendDirectory, FrontendUtils.SERVICE_WORKER_SRC)
                .exists()
                || new File(frontendDirectory, FrontendUtils.SERVICE_WORKER_SRC_JS).exists();

        String serviceWorkerFile = FrontendUtils.SERVICE_WORKER_SRC;
        if (new File(frontendDirectory, FrontendUtils.SERVICE_WORKER_SRC_JS).exists()) {
            serviceWorkerFile = FrontendUtils.SERVICE_WORKER_SRC_JS;
        }
