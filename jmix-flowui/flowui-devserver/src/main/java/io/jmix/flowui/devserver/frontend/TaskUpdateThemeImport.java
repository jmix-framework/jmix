...
import static io.jmix.flowui.devserver.frontend.FrontendUtils.THEME_IMPORTS_D_TS_NAME;
import static io.jmix.flowui.devserver.frontend.FrontendUtils.THEME_IMPORTS_NAME;
...
public class TaskUpdateThemeImport implements FallibleCommand {
    ...
    public static final String APPLICATION_FRONTEND_THEMES = "frontend/themes";
        ...
        if (existingAppThemeDirectories.size() >= 2) {
            ...
            boolean themeFoundInJar = existingAppThemeDirectories.stream()
                    ...
                    .anyMatch(path -> path.contains(
                            Paths.get(FrontendUtils.FLOW_NPM_PACKAGE_NAME).toString()));
