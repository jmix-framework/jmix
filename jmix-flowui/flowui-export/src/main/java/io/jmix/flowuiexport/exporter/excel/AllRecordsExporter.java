...
package io.jmix.flowuiexport.exporter.excel;
...
import io.jmix.flowuiexport.ExportActionProperties;
...
/**
 * Class is used by {@link io.jmix.flowuiexport.action.ExportAction} for exporting all records from the database.
 */
@Component("flowui_AllRecordsExporter")
