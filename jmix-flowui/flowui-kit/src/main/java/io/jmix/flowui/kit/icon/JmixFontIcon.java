...
public enum JmixFontIcon implements IconFactory<FontIcon> {
    ...
    /*
     * Vaadin icons
     * CAUTION: copied from com.vaadin.flow.component.icon.VaadinIcon [last update Vaadin 24.10.6]
     */
    ABACUS,
    ABSOLUTE_POSITION,
    ACADEMY_CAP,
     ...
     * CAUTION: copied from com.vaadin.flow.theme.lumo.LumoIcon [last update Vaadin 24.10.6]
     */
