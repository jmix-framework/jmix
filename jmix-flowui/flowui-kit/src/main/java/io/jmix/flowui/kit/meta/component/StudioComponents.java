...
public interface StudioComponents {
    ...
    @StudioComponent(
            ...
            properties = {
                    ...
                    @StudioProperty(xmlAttribute = "readOnly", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.BOOLEAN,
                            defaultValue = "false"),
                    @StudioProperty(xmlAttribute = "required", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.BOOLEAN,
                            defaultValue = "false"),
                    @StudioProperty(xmlAttribute = "requiredMessage", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.LOCALIZED_STRING),
    ...
    @StudioComponent(
            ...
            properties = {
                    @StudioProperty(xmlAttribute = "alignSelf", category = StudioProperty.Category.POSITIONING, type = StudioPropertyType.ENUMERATION,
                            ...
                            defaultValue = "AUTO",
                            options = {"START", "END", "CENTER", "STRETCH", "BASELINE", "AUTO"}),
                    @StudioProperty(xmlAttribute = "allowCustomValue", category = StudioProperty.Category.VALIDATION, type = StudioPropertyType.BOOLEAN,
                            defaultValue = "false"),
                    @StudioProperty(xmlAttribute = "autofocus", type = StudioPropertyType.BOOLEAN,
                            defaultValue = "false"),
                    ...
                    @StudioProperty(xmlAttribute = "classNames", category = StudioProperty.Category.LOOK_AND_FEEL, type = StudioPropertyType.VALUES_LIST),
                    @StudioProperty(xmlAttribute = "css", category = StudioProperty.Category.LOOK_AND_FEEL, type = StudioPropertyType.STRING),
                    @StudioProperty(xmlAttribute = "datatype", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.DATATYPE_ID,
                            typeParameter = "V"),
                    ...
                    @StudioProperty(xmlAttribute = "minHeight", category = StudioProperty.Category.SIZE, type = StudioPropertyType.SIZE, options = {"AUTO", "100%"}),
                    @StudioProperty(xmlAttribute = "minWidth", category = StudioProperty.Category.SIZE, type = StudioPropertyType.SIZE, options = {"AUTO", "100%"}),
                    @StudioProperty(xmlAttribute = "pageSize", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.INTEGER),
    ...
    @StudioComponent(
            ...
            properties = {
                    @StudioProperty(xmlAttribute = "alignSelf", category = StudioProperty.Category.POSITIONING, type = StudioPropertyType.ENUMERATION,
                            ...
                            defaultValue = "AUTO",
                            options = {"START", "END", "CENTER", "STRETCH", "BASELINE", "AUTO"}),
                    @StudioProperty(xmlAttribute = "allowCustomValue", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.BOOLEAN,
                            defaultValue = "false"),
    ...
    @StudioComponent(
            ...
            properties = {
                    ...
                    @StudioProperty(xmlAttribute = "colspan", category = StudioProperty.Category.POSITIONING, type = StudioPropertyType.INTEGER),
                    @StudioProperty(xmlAttribute = "dataContainer", category = StudioProperty.Category.DATA_BINDING, type = StudioPropertyType.COLLECTION_OR_INSTANCE_DATA_CONTAINER_REF),
                    @StudioProperty(xmlAttribute = "datatype", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.ENUMERATION,
    ...
    @StudioComponent(
            ...
            properties = {
                    ...
                    @StudioProperty(xmlAttribute = "aggregatable", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.BOOLEAN,
                            defaultValue = "false"),
                    @StudioProperty(xmlAttribute = "aggregationPosition", category = StudioProperty.Category.POSITIONING, type = StudioPropertyType.ENUMERATION,
                    ...
                    @StudioProperty(xmlAttribute = "dataContainer", category = StudioProperty.Category.DATA_BINDING,
                            ...
                            typeParameter = "E"),
                    @StudioProperty(xmlAttribute = "detailsVisibleOnClick", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.BOOLEAN,
                            defaultValue = "false"),
                    @StudioProperty(xmlAttribute = "dropMode", category = StudioProperty.Category.LOOK_AND_FEEL, type = StudioPropertyType.ENUMERATION,
                    ...
                    @StudioProperty(xmlAttribute = "minHeight", category = StudioProperty.Category.SIZE, type = StudioPropertyType.SIZE, options = {"AUTO", "100%"}),
                    @StudioProperty(xmlAttribute = "minWidth", category = StudioProperty.Category.SIZE, type = StudioPropertyType.SIZE, options = {"AUTO", "100%"}),
                    @StudioProperty(xmlAttribute = "multiSort", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.BOOLEAN,
                            defaultValue = "false"),
                    ...
                    @StudioProperty(xmlAttribute = "pageSize", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.INTEGER, defaultValue = "50"),
                    @StudioProperty(xmlAttribute = "rowDraggable", category = StudioProperty.Category.LOOK_AND_FEEL, type = StudioPropertyType.BOOLEAN,
                            defaultValue = "false"),
    ...
    @StudioComponent(
            ...
            properties = {
                    @StudioProperty(xmlAttribute = "alignSelf", category = StudioProperty.Category.POSITIONING, type = StudioPropertyType.ENUMERATION,
                            ...
                            defaultValue = "AUTO",
                            options = {"START", "END", "CENTER", "STRETCH", "BASELINE", "AUTO"}),
                    @StudioProperty(xmlAttribute = "autoApply", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.BOOLEAN),
                    @StudioProperty(xmlAttribute = "applyShortcut", type = StudioPropertyType.STRING),
                    @StudioProperty(xmlAttribute = "classNames", category = StudioProperty.Category.LOOK_AND_FEEL, type = StudioPropertyType.VALUES_LIST),
                    @StudioProperty(xmlAttribute = "css", category = StudioProperty.Category.LOOK_AND_FEEL, type = StudioPropertyType.STRING),
                    @StudioProperty(xmlAttribute = "colspan", category = StudioProperty.Category.POSITIONING, type = StudioPropertyType.INTEGER),
                    @StudioProperty(xmlAttribute = "dataLoader", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.DATA_LOADER_REF,
                            required = true),
                    @StudioProperty(xmlAttribute = "enabled", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.BOOLEAN,
                            defaultValue = "true"),
                    @StudioProperty(xmlAttribute = "height", category = StudioProperty.Category.SIZE, type = StudioPropertyType.SIZE, options = {"AUTO", "100%"}),
    ...
    @StudioComponent(
            ...
            properties = {
                    ...
                    @StudioProperty(xmlAttribute = "id", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.COMPONENT_ID),
                    @StudioProperty(xmlAttribute = "label", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.LOCALIZED_STRING),
                    @StudioProperty(xmlAttribute = "labelPosition", category = StudioProperty.Category.POSITIONING, type = StudioPropertyType.ENUMERATION,
    ...
    @StudioComponent(
            ...
            properties = {
                    ...
                    @StudioProperty(xmlAttribute = "spacing", category = StudioProperty.Category.LOOK_AND_FEEL, type = StudioPropertyType.BOOLEAN, defaultValue = "true"),
                    ...
                    @StudioProperty(xmlAttribute = "expand", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.COMPONENT_REF),
                    @StudioProperty(xmlAttribute = "alignItems", category = StudioProperty.Category.POSITIONING, type = StudioPropertyType.ENUMERATION,
                            setParameterFqn = "com.vaadin.flow.component.orderedlayout.FlexComponent$Alignment",
                            classFqn = "com.vaadin.flow.component.orderedlayout.FlexComponent$Alignment",
                            defaultValue = "START",
                            options = {"START", "END", "CENTER", "STRETCH", "BASELINE", "AUTO"}),
                    @StudioProperty(xmlAttribute = "boxSizing", category = StudioProperty.Category.POSITIONING, type = StudioPropertyType.ENUMERATION,
                    ...
                    @StudioProperty(xmlAttribute = "justifyContent", category = StudioProperty.Category.POSITIONING, type = StudioPropertyType.ENUMERATION,
    ...
    @StudioComponent(
            ...
            properties = {
                    ...
                    @StudioProperty(xmlAttribute = "required", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.BOOLEAN, defaultValue = "false"),
                    @StudioProperty(xmlAttribute = "requiredMessage", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.LOCALIZED_STRING),
    ...
    @StudioComponent(
            ...
            properties = {
                    ...
                    @StudioProperty(xmlAttribute = "hideAllEnabled", type = StudioPropertyType.BOOLEAN,
                            defaultValue = "true"),
                    @StudioProperty(xmlAttribute = "icon", category = StudioProperty.Category.LOOK_AND_FEEL, type = StudioPropertyType.ICON, initialValue = "COG"),
                    @StudioProperty(xmlAttribute = "id", category = StudioProperty.Category.GENERAL, type = StudioPropertyType.COMPONENT_ID),
