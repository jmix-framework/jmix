...
/**
 * A list of views available in the flowui module. The index may be used while defining view access using the
 * simple-security module.
 */
public interface FlowuiViewIndex {

    ViewIndexEntry addConditionView = new ViewIndexEntry(AddConditionView.ID);
