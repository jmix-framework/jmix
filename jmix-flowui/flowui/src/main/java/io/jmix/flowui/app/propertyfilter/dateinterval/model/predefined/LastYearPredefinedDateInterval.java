...
@Internal
@Component("flowui_LastYearPredefinedDateInterval")
@Order(JmixOrder.HIGHEST_PRECEDENCE + 70)
public class LastYearPredefinedDateInterval extends PredefinedDateInterval {

    public static final String NAME = "lastYear";
    ...
    public String apply(String property) {
        return String.format("@between({E}.%s, now-1, now, year)", property);
    }
}
