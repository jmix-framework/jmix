...
public class UiComponentsGenerator {
    ...
    public UiComponentsGenerator(List<ComponentGenerationStrategy> componentGenerationStrategies) {
        this.componentGenerationStrategies = componentGenerationStrategies;
    }
