...
public abstract class CompositeComponentAction<A extends CompositeComponentAction<A, C>, C extends CompositeComponent>
        extends SecuredBaseAction implements TargetAction<C>, ExecutableAction {

    protected C target;

    public CompositeComponentAction(String id) {
        super(id);
