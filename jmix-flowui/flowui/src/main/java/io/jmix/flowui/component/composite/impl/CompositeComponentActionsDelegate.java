...
public class CompositeComponentActionsDelegate extends AbstractActionsHolderSupport<CompositeComponent<?>> {

    public CompositeComponentActionsDelegate(CompositeComponent<?> component) {
        super(component);
    }
    ...
    protected void attachAction(Action action) {
        ...
        if (action instanceof CompositeComponentAction compositeComponentAction) {
            compositeComponentAction.setTarget(component);
        }
    }
