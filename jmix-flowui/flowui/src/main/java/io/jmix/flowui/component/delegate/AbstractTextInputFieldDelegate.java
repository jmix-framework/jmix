 ...
 */
public abstract class AbstractTextInputFieldDelegate<C extends AbstractField<?, String>, V>
        extends AbstractFieldDelegate<C, V, String> {

    private static final Logger log = LoggerFactory.getLogger(AbstractTextInputFieldDelegate.class);
    ...
    protected AbstractTextInputFieldDelegate(C component) {
        super(component);
    }
