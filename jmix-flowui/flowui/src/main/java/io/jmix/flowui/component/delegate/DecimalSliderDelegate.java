...
@Component("flowui_DecimalSliderDelegate")
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class DecimalSliderDelegate extends AbstractSliderDelegate<JmixDecimalSlider, Double, Double> {

    public DecimalSliderDelegate(JmixDecimalSlider component) {
        super(component);
    }
