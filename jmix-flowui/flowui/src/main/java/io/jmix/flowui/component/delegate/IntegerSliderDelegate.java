...
@Component("flowui_IntegerSliderDelegate")
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class IntegerSliderDelegate extends AbstractSliderDelegate<JmixIntegerSlider, Integer, Integer> {

    public IntegerSliderDelegate(JmixIntegerSlider component) {
        super(component);
    }
