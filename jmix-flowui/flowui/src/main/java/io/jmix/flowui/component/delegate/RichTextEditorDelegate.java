 ...
 */
@Component("flowui_RichTextEditorDelegate")
@Scope(BeanDefinition.SCOPE_PROTOTYPE)
public class RichTextEditorDelegate<C extends AbstractField<?, String>, V> extends AbstractFieldDelegate<C, V, String> {

    public RichTextEditorDelegate(C component) {
        super(component);
    }
