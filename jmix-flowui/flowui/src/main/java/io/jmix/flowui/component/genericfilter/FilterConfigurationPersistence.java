...
public interface FilterConfigurationPersistence {
    ...
    void save(FilterConfigurationModel configurationModel);

    @Nullable
    FilterConfigurationModel load(String configurationId, String componentId, String username);

    List<FilterConfigurationModel> load(String componentId, String username);
}
