...
public class UiDataFilterConfigurationDetail extends AbstractConfigurationDetail {
    ...
    protected InstanceContainer<FilterConfigurationModel> configurationDc;
     ...
     */
    public InstanceContainer<FilterConfigurationModel> getConfigurationDc() {
     ...
     */
    public void setConfigurationDc(InstanceContainer<FilterConfigurationModel> configurationDc) {
    ...
    public void initUsername() {
        FilterConfigurationModel editedConfigurationModel = configurationDc.getItem();
