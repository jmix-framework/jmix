...
//        this.dateIntervalUtils = dateIntervalUtils;
     ...
     * @return a prefix
     */
    public String getPropertyFilterPrefix(Optional<String> id, String property) {
        return id.orElse("propertyFilter_" + property) + "_";
    }
    ...
    public String getPropertyFilterCaption(MetaClass metaClass, String property,
        ...
        if (operationCaptionVisible) {
            sb.append(" ").append(getOperationText(operation));
        }
