...
/**
 * Abstract base class for {@link UiComponentSettings} implementations that use JSON structure.
 *
 * @param <S> type of settings
 * @param <J> type of settings JSON
 */
@Internal
public abstract class AbstractUiComponentSettingsJson<
        S extends UiComponentSettings<S>,
        J extends AbstractUiComponentSettingsJson<S, J>
        >
        extends AbstractUiComponentSettings<S> {
     ...
     * @return current instance of {@link AbstractUiComponentSettingsJson}
     */
    public J put(JsonObject json) {
