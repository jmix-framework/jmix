...
public interface UiComponentSettings<S extends UiComponentSettings<S>> {
    ...
    /**
     * @return a {@link Component} id to which settings are corresponded
     */
    String getOwnerId();
    ...
    /**
     * Puts a value with {@link String} type. Will replace value if the same key already exists.
     *
     * @param id    e.g. component id
     * @param key   key with which associated provided value, e.g., component's width or some state
     * @param value {@link String} value
     * @return current instance of {@link UiComponentSettings}
     */
    S put(String id, String key, @Nullable String value);

    /**
     * Puts a value with {@link Integer} type. Will replace value if the same key already exists.
     *
     * @param id    e.g. component id
     ...
     * @return current instance of {@link UiComponentSettings}
     */
    S put(String id, String key, @Nullable Integer value);

    /**
     * Puts a value with {@link Long} type. Will replace value if the same key already exists.
     *
     * @param id    e.g. component id
     * @param key   key with which associated provided value, e.g., component's property or some state
     ...
     * @return current instance of {@link UiComponentSettings}
     */
    S put(String id, String key, @Nullable Long value);

    /**
     * Puts a value with {@link Double} type. Will replace value if the same key already exists.
     *
     * @param id    e.g. component id
     * @param key   key with which associated provided value, e.g., component's property or some state
     ...
     * @return current instance of {@link UiComponentSettings}
     */
    S put(String id, String key, @Nullable Double value);

    /**
     * Puts a value with {@link Boolean}. Will replace value if the same key already exists.
     *
     * @param id    e.g. component id
     * @param key   key with which associated provided value, e.g., component's property or some state
     ...
     * @return current instance of {@link UiComponentSettings}
     */
    S put(String id, String key, @Nullable Boolean value);

    /**
     * Puts component's settings, e.g {@link JmixDetailsSettings}. If setting with provided id already exists it will be
     * replaced.
     *
