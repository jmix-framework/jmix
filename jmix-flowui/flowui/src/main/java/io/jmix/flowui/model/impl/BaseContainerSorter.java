...
public abstract class BaseContainerSorter implements Sorter {
    ...
    protected Comparator<?> createComparator(Sort.Order sortOrder, MetaClass metaClass) {
        ...
        LocalizedEntityValuesComparator<Object> comparator =
                new LocalizedEntityValuesComparator<>(asc, metaClass, beanFactory);
        return Comparator.comparing(e -> comparator.getComparedValue(e, propertyPath), comparator);
    }
}
