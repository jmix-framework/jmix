...
public final class EditorTypeExtractor {
    ...
    public static Optional<Class<?>> extractEntityClass(ScreenInfo screenInfo) {
        return extractEntityClass(screenInfo.getControllerClass());
    }

    public static Optional<Class<?>> extractEntityClass(Class<? extends Screen> screenClass) {
