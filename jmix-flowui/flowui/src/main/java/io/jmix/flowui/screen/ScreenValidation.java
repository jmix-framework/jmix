...
@org.springframework.stereotype.Component("flowui_ScreenValidation")
public class ScreenValidation {
    ...
    @Autowired
    public ScreenValidation(Messages messages,
                            Validator validator,
                            Dialogs dialogs,
    ...
    public void showValidationErrors(ValidationErrors errors) {
        showValidationErrorsNotification(errors,
                screenProperties.getValidationNotificationDuration(),
                Notification.Position.valueOf(screenProperties.getValidationNotificationPosition()),
                Notifications.Type.valueOf(screenProperties.getValidationNotificationType()));
    }
    ...
    public UnsavedChangesDialogResult showUnsavedChangesDialog(Screen origin) {
    ...
    public SaveChangesDialogResult showSaveConfirmationDialog(Screen origin) {
