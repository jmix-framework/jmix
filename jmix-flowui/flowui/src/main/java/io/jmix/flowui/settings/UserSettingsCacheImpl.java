...
public class UserSettingsCacheImpl implements UserSettingsCache {
    ...
    public UserSettingsCacheImpl(@Nullable UserSettingsService userSettingsService) {
    ...
    public String get(String key) {
        ...
        String value = getUserSettingsService().load(key).orElse(null);
    ...
    public void put(String key, @Nullable String value) {
        ...
        getUserSettingsService().save(key, value);
    ...
    public void delete(String key) {
        ...
        getUserSettingsService().delete(key);
    ...
    protected UserSettingsService getUserSettingsService() {
        if (userSettingsService == null) {
            throw new IllegalStateException("UserSettingsService is not available");
        }
