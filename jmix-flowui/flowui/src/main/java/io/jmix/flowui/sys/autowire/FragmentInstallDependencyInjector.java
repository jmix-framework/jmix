 ...
 * These can be installations to the {@link Fragment} or to the components in the fragment.
 */
@Order(JmixOrder.LOWEST_PRECEDENCE - 70)
@Component("flowui_FragmentInstallDependencyInjector")
public class FragmentInstallDependencyInjector extends AbstractInstallDependencyInjector {
    ...
    @Nullable
    @Override
    protected Object getInstallTargetInstance(Composite<?> composite, Install annotation) {
