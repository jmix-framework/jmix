...
public class ViewClickNotifierDependencyInjector extends AbstractClickNotifierDependencyInjector {
    ...
    protected Object getEventTarget(Composite<?> composite, String target) {
        return AutowireUtils.findMethodTarget(composite, target, UiComponentUtils::findComponent);
    }
