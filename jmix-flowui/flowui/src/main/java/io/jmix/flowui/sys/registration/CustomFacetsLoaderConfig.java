...
import io.jmix.flowui.xml.facet.FacetLoaderConfig;
...
/**
 * Configuration for custom {@link FacetLoader} implementations from add-ons and project configurations.
 */
@Order(JmixOrder.HIGHEST_PRECEDENCE + 10)
@Component("flowui_CustomFacetsLoaderConfig")
public class CustomFacetsLoaderConfig implements FacetLoaderConfig {
