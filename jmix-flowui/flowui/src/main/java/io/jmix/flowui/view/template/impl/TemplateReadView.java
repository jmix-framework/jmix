...
/**
 * Generic base controller for template-generated read views.
 * <p>
...
public class TemplateReadView extends StandardReadView<Object> {
    ...
    protected String getReadEntityContainerId() {
        return DEFAULT_READ_ENTITY_CONTAINER_ID;
    }

    @Override
    protected InstanceContainer<Object> getEntityContainer() {
        return getViewData().getContainer(getReadEntityContainerId());
    }
}
