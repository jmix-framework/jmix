...
public class DefaultFacetLoaderConfig implements FacetLoaderConfig {
    ...
    protected void initDefaultLoaders() {
        ...
        loaders.put("urlQueryParameters", ViewUrlQueryParametersFacetLoader.class);
        loaders.put("fragmentUrlQueryParameters", FragmentUrlQueryParametersFacetLoader.class);
