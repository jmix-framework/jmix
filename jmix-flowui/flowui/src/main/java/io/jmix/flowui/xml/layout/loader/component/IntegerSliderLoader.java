...
public class IntegerSliderLoader extends AbstractComponentLoader<JmixIntegerSlider> {

    protected DataLoaderSupport dataLoaderSupport;

    @Override
    protected JmixIntegerSlider createComponent() {
        return factory.create(JmixIntegerSlider.class);
    }
