...
@Component("flowui_DataContainerPropertyParser")
public class DataContainerPropertyParser implements PropertyParser {
    ...
    public Object parse(PropertyParsingContext context) {
        if (context.context() instanceof ComponentLoader.ComponentContext componentContext) {
            return componentContext.getDataHolder().getContainer(context.value());
        }
