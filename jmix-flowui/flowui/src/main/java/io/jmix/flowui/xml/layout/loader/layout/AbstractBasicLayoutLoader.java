...
public abstract class AbstractBasicLayoutLoader<T extends Component & ThemableLayout & FlexComponent>
    ...
    public void loadComponent() {
        loadThemableAttributes(resultComponent, element);
        loadFlexibleAttributes(resultComponent, element);
