...
class DataGridFilterUrlQueryParametersBinderTest extends FlowuiTestSpecification {
    ...
    // --- A. New format deserialization ---

    def "applies new-format URL with simple value"() {
        when:
    ...
    def "applies new-format URL with underscore in value (user bug regression)"() {
        when:
    ...
    def "applies new-format URL with multiple underscores in value"() {
        when:
    ...
    def "applies new-format URL with leading underscore in value"() {
        when:
    ...
    def "applies new-format URL with multi-word operation and underscore in value"() {
        when:
    ...
    // --- B. Legacy format deserialization (backward compatibility) ---

    def "applies legacy-format URL with simple value"() {
        when:
        def filter = applyUrlAndGetFilter("name_contains_abc")
    ...
    def "applies legacy-format URL with two underscores in value"() {
        when:
        def filter = applyUrlAndGetFilter("name_contains_a_b_c")
    ...
    def "applies legacy-format URL with multi-word operation"() {
        when:
        def filter = applyUrlAndGetFilter("name_not-equal_abc")
