...
package component.checkboxgroup.view;
...
@ViewController("JmixCheckboxGroupOrderDetailTestView")
@ViewDescriptor("checkboxgroup-order-detail-test-view.xml")
@EditedEntityContainer("orderDc")
public class JmixCheckboxGroupOrderDetailTestView extends StandardDetailView<Order> {
    @ViewComponent
    public CollectionContainer<OrderLine> orderLinesDc;
    @ViewComponent
    public TypedTextField<String> numberField;
    @ViewComponent
    public JmixCheckboxGroup<OrderLine> orderLinesField;
