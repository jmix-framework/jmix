...
package component.multiselectcombobox.view;
...
@ViewController("JmixMultiSelectComboBoxOrderDetailTestView")
@ViewDescriptor("multiselectcombobox-order-detail-test-view.xml")
@EditedEntityContainer("orderDc")
public class JmixMultiSelectComboBoxOrderDetailTestView extends StandardDetailView<Order> {
    @ViewComponent
    public CollectionContainer<OrderLine> orderLinesDc;
    @ViewComponent
    public TypedTextField<String> numberField;
    @ViewComponent
    public JmixMultiSelectComboBox<OrderLine> orderLinesField;
