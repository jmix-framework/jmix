...
@Route(value = "grid-layout-view")
@ViewController("GridLayoutView")
@ViewDescriptor("grid-layout-view.xml")
public class GridLayoutView extends StandardView {

    @ViewComponent
    public GridLayout<?> gridLayoutId;

    @ViewComponent
    public GridLayout<?> gridLayoutBindingId;
