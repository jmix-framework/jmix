...
@Route(value = "html-data-container-view")
@ViewController("HtmlDataContainerView")
@ViewDescriptor("html-data-container-view.xml")
public class HtmlDataContainerView extends StandardView {
