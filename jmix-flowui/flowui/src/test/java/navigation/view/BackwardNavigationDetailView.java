...
@Route(value = "customers/:id")
@ViewController("test_Customer.detail")
@ViewDescriptor("backward-navigation-detail-view.xml")
@EditedEntityContainer("customerDc")
public class BackwardNavigationDetailView extends StandardDetailView<Customer> {
