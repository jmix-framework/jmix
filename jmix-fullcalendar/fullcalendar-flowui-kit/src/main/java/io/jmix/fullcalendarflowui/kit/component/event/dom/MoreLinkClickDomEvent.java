 ...
 * INTERNAL.
 */
@DomEvent("jmix-more-link-click")
public class MoreLinkClickDomEvent extends ComponentEvent<JmixFullCalendar> {

    protected final ObjectNode context;

    public MoreLinkClickDomEvent(JmixFullCalendar source,
                                 boolean fromClient,
