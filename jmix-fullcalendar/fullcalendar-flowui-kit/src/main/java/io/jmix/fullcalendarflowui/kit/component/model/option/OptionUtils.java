...
public final class OptionUtils {
    ...
    public static final String UNSELECT_CANCEL = "unselectCancel";
    public static final String VIEWS = "views";
    public static final String WEEK_NUMBER_FORMAT = "weekNumberFormat";

    public static final String ALL_DAY_MAINTAIN_DURATION = "allDayMaintainDuration";
    ...
    public static final String EVENT_CONSTRAINT = "eventConstraint";
    ...
    public static final String SELECT_ALLOW = "selectAllow";
    public static final String SELECT_CONSTRAINT = "selectConstraint";
    ...
    public static final String SLOT_LABEL_CLASS_NAMES = "slotLabelClassNames";
    ...
    public static final String VALID_RANGE = "validRange";
