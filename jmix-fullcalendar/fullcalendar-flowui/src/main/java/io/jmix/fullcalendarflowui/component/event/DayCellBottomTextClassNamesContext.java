 ...
 */
public class DayCellBottomTextClassNamesContext extends AbstractFullCalendarContext {
    ...
    public DayCellBottomTextClassNamesContext(FullCalendar fullCalendar,
                                    LocalDate date,
                                    DayOfWeek dayOfWeek,
                                    boolean isDisabled,
                                    boolean isFuture,
    ...
    /**
     * @return the generated text to be displayed at the bottom of the day cell
     */
