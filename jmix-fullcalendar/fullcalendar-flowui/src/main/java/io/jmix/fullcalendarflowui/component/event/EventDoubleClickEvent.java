...
/**
 * The event is fired when a calendar event is double-clicked.
 */
public class EventDoubleClickEvent extends AbstractClickEvent {
    ...
    public EventDoubleClickEvent(FullCalendar fullCalendar,
                                 boolean fromClient,
