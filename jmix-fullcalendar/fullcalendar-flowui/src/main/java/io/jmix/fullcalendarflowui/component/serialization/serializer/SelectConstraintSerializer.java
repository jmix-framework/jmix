...
import io.jmix.fullcalendarflowui.component.model.option.SelectConstraint;

import java.io.IOException;

public class SelectConstraintSerializer  extends StdSerializer<SelectConstraint> {

    public SelectConstraintSerializer() {
        super(SelectConstraint.class);
    }

    @Override
    public void serialize(SelectConstraint value, JsonGenerator gen, SerializerProvider provider) throws IOException {
        if (value == null) {
            gen.writeNull();
            return;
        }
