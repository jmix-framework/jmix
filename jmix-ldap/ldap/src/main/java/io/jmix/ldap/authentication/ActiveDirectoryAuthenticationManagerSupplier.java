...
public class ActiveDirectoryAuthenticationManagerSupplier implements AddonAuthenticationManagerSupplier {
    ...
    public ActiveDirectoryAuthenticationManagerSupplier(StandardAuthenticationProvidersProducer providersProducer,
