 ...
 */
public class FileUploadField extends AbstractUpload<FileUploadField> {

    public FileUploadField(By by) {
        super(by);
    }
    ...
    protected String getUploadButtonCssSelector() {
        return "jmix-upload-field[%s='%s'] .jmix-upload-button".formatted(
                UI_TEST_ID,
