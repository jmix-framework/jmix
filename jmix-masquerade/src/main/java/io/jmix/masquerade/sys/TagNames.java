...
public class TagNames {
    ...
    public static final By COMBO_BOX_OVERLAY = tagName("vaadin-combo-box-scroller");
    public static final By COMBO_BOX_ITEM = tagName("vaadin-combo-box-item");
    public static final By MENU_BAR_OVERLAY = tagName("vaadin-menu-bar-list-box");
    public static final By MENU_BAR_ITEM = tagName("vaadin-menu-bar-item");
    public static final By SELECT_OVERLAY = tagName("vaadin-select-list-box");
    public static final By SELECT_VALUE_BUTTON = tagName("vaadin-select-value-button");
    public static final By SELECT_ITEM = tagName("vaadin-select-item");
    public static final By TEXT_AREA = tagName("textarea");
    public static final By MULTI_SELECT_COMBO_BOX_OVERLAY = tagName("vaadin-multi-select-combo-box-scroller");
