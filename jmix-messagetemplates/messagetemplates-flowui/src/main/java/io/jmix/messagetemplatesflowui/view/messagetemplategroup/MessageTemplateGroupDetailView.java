...
@RouteAlias(value = "msgtmp/messagetemplategroup/:id", layout = DefaultMainViewParent.class)
@Route(value = "msgtmp/message-template-group/:id", layout = DefaultMainViewParent.class)
