...
import test_support.MultitenancyUiTestConfiguration
...
@ContextConfiguration(classes = [SecurityUiConfiguration.class,
        UiConfiguration.class, SecurityDataConfiguration, EclipselinkConfiguration, MultitenancyUiTestConfiguration, MultitenancyConfiguration])
