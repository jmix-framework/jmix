...
public class HeatmapRendererOptions extends PivotTableOptionsObservable {

    protected JsFunction colorScaleGeneratorFunction;
     ...
     */
    public void setColorScaleGeneratorFunction(JsFunction colorScaleGeneratorFunction) {
