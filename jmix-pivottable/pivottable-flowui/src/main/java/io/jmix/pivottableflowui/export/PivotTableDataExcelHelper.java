...
import io.jmix.pivottableflowui.export.model.PivotDataRow;
...
import static io.jmix.pivottableflowui.export.PivotTableExcelExporter.MAX_ROW_INDEX;

/**
 * Helps to convert {@link PivotDataRow} to list with separated cells and provides methods for merging cells.
 */
public class PivotTableDataExcelHelper {
    ...
    public PivotTableDataExcelHelper(PivotData pivotData) {
