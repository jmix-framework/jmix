...
@ContextConfiguration(classes = [PivotTableFlowuiTestConfiguration, FlowuiTestAssistConfiguration])
class PivotTableFlowuiTestSpecification extends Specification {

    private static final String APP_ID = "testPivotTableFlowuiAppId"
