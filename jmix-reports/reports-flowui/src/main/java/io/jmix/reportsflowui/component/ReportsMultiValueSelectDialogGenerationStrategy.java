 ...
 * @param <E> entity type
 */
@org.springframework.stereotype.Component("report_ReportsMultiValueSelectDialogGenerationStrategy")
public class ReportsMultiValueSelectDialogGenerationStrategy<E> extends AbstractComponentGenerationStrategy
        implements Ordered {

    protected DataComponents dataComponents;

    public ReportsMultiValueSelectDialogGenerationStrategy(UiComponents uiComponents,
                                                           Metadata metadata,
    ...
    public Component createComponent(ComponentGenerationContext context) {
        if (context.getTargetClass() != null &&
                ...
                && context instanceof ReportsMultiValueSelectContext<?>) {
    ...
    protected Component createComponentInternal(ComponentGenerationContext context) {
        MultiValueSelectView.MultiValueSelectContext generationContext = (MultiValueSelectView.MultiValueSelectContext) context;
    ...
    protected Component createComboBox(MultiValueSelectView.MultiValueSelectContext<E> context) {
    ...
    @Nullable
    protected Component createEntityField(MultiValueSelectView.MultiValueSelectContext<E> context) {
    ...
    @SuppressWarnings("unchecked")
    protected Component createEntityComboBox(MultiValueSelectView.MultiValueSelectContext<E> context, MetaClass metaClass) {
    ...
    @SuppressWarnings("unchecked")
    public Component createEntityPicker(MultiValueSelectView.MultiValueSelectContext<E> context, MetaClass metaClass) {
        ReportsMultiEntityPicker<E> entityPicker = uiComponents.create(ReportsMultiEntityPicker.class);
    ...
    protected Component createEnumField(MultiValueSelectView.MultiValueSelectContext<E> context) {
    ...
    @SuppressWarnings({"unchecked", "rawtypes"})
    protected Component createFieldWithItems(MultiValueSelectView.MultiValueSelectContext<E> context) {
    ...
    @SuppressWarnings("unchecked")
    @Nullable
    protected Component createDatatypeField(MultiValueSelectView.MultiValueSelectContext<E> context) {
    ...
    @SuppressWarnings({"rawtypes", "unchecked"})
    protected Component createTextField(MultiValueSelectView.MultiValueSelectContext<E> context, Datatype<E> datatype) {
    ...
    @Override
    public int getOrder() {
        return JmixOrder.HIGHEST_PRECEDENCE + 350;
    }
}
