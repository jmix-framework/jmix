...
@Component
public class RuntimeReportGroupUtil {

    public static final String SIMPLE_RUNTIME_REPORT_GROUP_TITLE = "Simple runtime report";
    ...
    public ReportGroup constructSimpleReportGroup() {
        ...
        reportGroup.setTitle(SIMPLE_RUNTIME_REPORT_GROUP_TITLE);
