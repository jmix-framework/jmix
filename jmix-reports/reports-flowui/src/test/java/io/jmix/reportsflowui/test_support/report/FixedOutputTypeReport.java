 ...
 * The hidden parameter makes it runnable in the bulk print mode without the input parameters dialog.
 */
@ReportDef(
        name = "Report with a fixed output type",
        code = FixedOutputTypeReport.CODE
)
@InputParameterDef(
        alias = FixedOutputTypeReport.PARAM_TITLE,
        name = "Title",
...
public class FixedOutputTypeReport {

    public static final String CODE = "FIXED_OUTPUT_TYPE";
