...
@ReportDef(
        name = "Multi-template table report",
        code = MultiTemplateTableReport.CODE
)
@BandDef(
        name = "Root",
        root = true,
...
@TemplateDef(
        code = MultiTemplateTableReport.DOWNLOAD_TEMPLATE,
...
@TemplateDef(
        code = MultiTemplateTableReport.FIRST_TABLE_TEMPLATE,
...
@TemplateDef(
        code = MultiTemplateTableReport.SECOND_TABLE_TEMPLATE,
        outputType = ReportOutputType.TABLE,
        table = @TemplateTableDef(
                bands = @TableBandDef(
                        bandName = "Data",
                        columns = {
                                @TableColumnDef(key = "name", caption = "Label"),
                                @TableColumnDef(key = "count", caption = "Value")
                        }
                )
        )
)
public class MultiTemplateTableReport {

    public static final String CODE = "MULTI_TEMPLATE_TABLE";
    public static final String DOWNLOAD_TEMPLATE = "download";
    public static final String FIRST_TABLE_TEMPLATE = "tableOne";
    public static final String SECOND_TABLE_TEMPLATE = "tableTwo";
