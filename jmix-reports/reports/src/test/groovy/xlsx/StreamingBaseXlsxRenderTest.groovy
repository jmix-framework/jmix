...
/**
 * Base class for streaming XLSX rendering correctness tests: same template/band helpers as
 * {@link BaseXlsxRenderTest}, but rendering goes through {@link StreamingXlsxFormatter}.
 */
abstract class StreamingBaseXlsxRenderTest extends BaseXlsxRenderTest {
