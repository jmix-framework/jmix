...
/**
 * An LLM data set with nothing to generate from: the prompt is left out.
 */
@ReportDef(
        name = "Blank LLM prompt report",
        code = "blank-llm-prompt-report",
        uuid = "019fe0a1-3b1c-7a10-8f21-5c0d2a7c9e02",
...
@BandDef(
        ...
        dataSets = @DataSetDef(
                ...
                llm = @LlmDataSetParameters(maxResults = 10)
        )
)
@TemplateDef(
        code = "default",
...
public class BlankLlmPromptReport {
}
