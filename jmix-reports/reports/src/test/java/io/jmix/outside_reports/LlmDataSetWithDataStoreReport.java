...
/**
 * An LLM data set pointed at another data store, which its execution cannot use.
 */
@ReportDef(
        name = "LLM data set with data store report",
        code = "llm-data-set-with-data-store-report",
        uuid = "019fe0a1-3b1c-7a10-8f21-5c0d2a7c9e06",
...
public class LlmDataSetWithDataStoreReport {
}
