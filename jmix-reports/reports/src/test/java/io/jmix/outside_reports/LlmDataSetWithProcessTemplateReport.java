...
/**
 * An LLM data set asking for Groovy template processing, which its prompt never gets.
 */
@ReportDef(
        name = "LLM data set with process template report",
        code = "llm-data-set-with-process-template-report",
        uuid = "019fe0a1-3b1c-7a10-8f21-5c0d2a7c9e07",
...
public class LlmDataSetWithProcessTemplateReport {
}
