...
/**
 * An LLM data set stating both a prompt and a query — two sources for one property.
 */
@ReportDef(
        name = "LLM data set with query report",
        code = "llm-data-set-with-query-report",
        uuid = "019fe0a1-3b1c-7a10-8f21-5c0d2a7c9e03",
...
@BandDef(
        ...
        dataSets = @DataSetDef(
                ...
                query = "select o.number from sales_Order o",
...
public class LlmDataSetWithQueryReport {
}
