...
/**
 * LLM parameters on a data set of another type, where nothing would ever read them.
 */
@ReportDef(
        name = "LLM parameters on JPQL data set report",
        code = "llm-parameters-on-jpql-report",
        uuid = "019fe0a1-3b1c-7a10-8f21-5c0d2a7c9e04",
...
@BandDef(
        ...
        dataSets = @DataSetDef(
                ...
                query = "select o.number as number from sales_Order o",
                llm = @LlmDataSetParameters(prompt = "Order numbers")
        )
)
@TemplateDef(
        code = "default",
...
public class LlmParametersOnJpqlDataSetReport {
}
