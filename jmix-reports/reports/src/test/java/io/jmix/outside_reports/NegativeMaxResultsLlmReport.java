...
/**
 * An LLM data set whose row limit is negative, which names no number of rows.
 */
@ReportDef(
        name = "Negative max results LLM report",
        code = "negative-max-results-llm-report",
        uuid = "019fe0a1-3b1c-7a10-8f21-5c0d2a7c9e05",
...
@BandDef(
        ...
        dataSets = @DataSetDef(
                ...
                llm = @LlmDataSetParameters(prompt = "Order numbers", maxResults = -1)
        )
)
@TemplateDef(
        code = "default",
...
public class NegativeMaxResultsLlmReport {
}
