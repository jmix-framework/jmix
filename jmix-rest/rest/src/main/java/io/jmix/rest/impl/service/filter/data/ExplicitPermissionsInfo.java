...
public class ExplicitPermissionsInfo {

    private List<ShortPermissionInfo> entities;
    private List<ShortPermissionInfo> entityAttributes;
    private List<ShortPermissionInfo> specific;

    public ExplicitPermissionsInfo() {
    }
    ...
    @Nullable
    public List<ShortPermissionInfo> getSpecific() {
        return specific;
    }

    public void setSpecific(List<ShortPermissionInfo> specific) {
