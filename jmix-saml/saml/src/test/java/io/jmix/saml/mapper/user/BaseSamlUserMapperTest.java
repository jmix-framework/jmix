...
class BaseSamlUserMapperTest {
    ...
    private DefaultSamlUserMapper createMapper() {
        ...
        mapper.samlProperties = new SamlProperties(true, 128, "/",
    ...
    private Assertion assertion(String username, @Nullable String sessionIndex) {
    ...
    private OpenSaml4AuthenticationProvider.ResponseToken responseToken(String registrationId) {
