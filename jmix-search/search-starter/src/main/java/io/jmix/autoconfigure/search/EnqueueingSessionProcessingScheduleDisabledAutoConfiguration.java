...
public class EnqueueingSessionProcessingScheduleDisabledAutoConfiguration {
    ...
    @PostConstruct
    void cleanJob() {
        JobKey jobKey = JobKey.jobKey(EnqueueingSessionProcessingScheduleAutoConfiguration.JOB_NAME,
                EnqueueingSessionProcessingScheduleAutoConfiguration.JOB_GROUP);
        try {
