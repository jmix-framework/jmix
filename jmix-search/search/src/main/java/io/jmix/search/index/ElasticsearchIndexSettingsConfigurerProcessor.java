...
public class ElasticsearchIndexSettingsConfigurerProcessor {
    ...
    public Settings getSettingsForIndex(IndexConfiguration indexConfiguration) {
        //TODO Java API?
        Class<?> entityClass = indexConfiguration.getEntityClass();
        Settings.Builder resultSettingsBuilder = Settings.builder();
        ...
        return resultSettingsBuilder.put(commonSettings).put(entitySettings).build();
    }
