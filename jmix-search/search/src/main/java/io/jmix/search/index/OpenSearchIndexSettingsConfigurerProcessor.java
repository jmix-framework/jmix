...
@Component
public class OpenSearchIndexSettingsConfigurerProcessor { //todo base class with generic settings class?
    ...
    @Autowired
    public OpenSearchIndexSettingsConfigurerProcessor(List<OpenSearchIndexSettingsConfigurer> configurers) {
