...
@Component("search_EntityTrackingListenerDelegate")
public class EntityTrackingListenerDelegate {
    private static final Logger log = LoggerFactory.getLogger(EntityTrackingListenerDelegate.class);
    ...
    public void doOnBeforeEntitySave(DataStoreBeforeEntitySaveEvent event) {
