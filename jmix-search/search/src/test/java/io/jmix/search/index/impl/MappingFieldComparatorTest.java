...
class MappingFieldComparatorTest {
    ...
    void compareLeafFields_equal() {
        ...
        assertEquals(IndexMappingComparator.MappingComparingResult.EQUAL, comparator.compareLeafFields(fieldSettings1, fieldSettings2));
    }
    ...
    void compareLeafFields_not_compatible() {
        ...
        assertEquals(IndexMappingComparator.MappingComparingResult.NOT_COMPATIBLE, comparator.compareLeafFields(fieldSettings1, fieldSettings2));
    }
