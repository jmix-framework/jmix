...
@JmixEntity
@Table(name = "TEST_EMB_TRACK_REF_ENTITY_HD")
@Entity
public class TestEmbTrackRefEntityHD extends BaseEntityHD {
    @InstanceName
    @Column(name = "NAME")
    private String name;
    ...
    private TestEmbTrackRootEntityHD refToRoot;

    public TestEmbTrackRootEntityHD getRefToRoot() {
        return refToRoot;
    }

    public void setRefToRoot(TestEmbTrackRootEntityHD refToRoot) {
