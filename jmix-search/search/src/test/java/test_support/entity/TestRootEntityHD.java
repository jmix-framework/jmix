...
@JmixEntity
@Entity(name = "test_RootEntityHD")
@Table(name = "TEST_ROOT_ENTITY_HD")
public class TestRootEntityHD extends BaseEntityHD {
    ...
    private TestReferenceEntityHD oneToOneAssociation;
    ...
    public void setOneToManyAssociation(List<TestReferenceEntityHD> oneToManyAssociation) {
        this.oneToManyAssociation = oneToManyAssociation;
    }

    public TestReferenceEntityHD getOneToOneAssociation() {
        return oneToOneAssociation;
    }

    public void setOneToOneAssociation(TestReferenceEntityHD oneToOneAssociation) {
