...
public interface RoleHierarchyCandidatePredicate extends BiPredicate<BaseRole, BaseRole> {
    ...
    /**
     * Wraps the generic {@code BiPredicate<BaseRole, BaseRole>} in {@link RoleHierarchyCandidatePredicate} type.
     */
    static RoleHierarchyCandidatePredicate of(BiPredicate<BaseRole, BaseRole> p) {
        return p::test;
    }
}