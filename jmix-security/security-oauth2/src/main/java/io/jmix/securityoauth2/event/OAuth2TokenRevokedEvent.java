 ...
 */
public class OAuth2TokenRevokedEvent extends ApplicationEvent {
    protected TokenRevocationInitiator revocationInitiator;

    public OAuth2TokenRevokedEvent(OAuth2AccessToken source, TokenRevocationInitiator revocationInitiator) {
        super(source);
