...
public interface StudioSupersetComponents {
    ...
    @StudioComponent(
            ...
            properties = {
                    ...
                    @StudioProperty(xmlAttribute = "chartControlsVisibility", type = StudioPropertyType.BOOLEAN, defaultValue = "false"),
                    ...
                    @StudioProperty(xmlAttribute = "filtersExpanded", type = StudioPropertyType.BOOLEAN, defaultValue = "true"),
                    ...
                    @StudioProperty(xmlAttribute = "tabVisibility", type = StudioPropertyType.BOOLEAN, defaultValue = "false"),
                    @StudioProperty(xmlAttribute = "titleVisibility", type = StudioPropertyType.BOOLEAN, defaultValue = "false"),
