...
@Primary
@Component("tabmod_TabbedViewNavigationProcessor")
public class TabbedModeViewNavigationProcessor extends ViewNavigationProcessor {

    protected final Views views;
    protected final ViewBuilderProcessor viewBuilderProcessor;

    public TabbedModeViewNavigationProcessor(ViewSupport viewSupport,
