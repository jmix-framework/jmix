 ...
 * authserver).
 * <p>
 * If you need to define own {@link SecurityFilterChain} to configure custom API endpoints security, you can do it in
 ...
 */
@Configuration
public class ${project_classPrefix}SecurityConfiguration {
