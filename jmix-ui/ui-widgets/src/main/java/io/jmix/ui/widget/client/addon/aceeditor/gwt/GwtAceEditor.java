...
public class GwtAceEditor extends JavaScriptObject {
	...
	public final native void addChangeHandler(GwtAceChangeHandler handler) /*-{
		var cb = function(event) {
			handler.@io.jmix.ui.widget.client.addon.aceeditor.gwt.GwtAceChangeHandler::onChange(Lio/jmix/ui/widget/client/addon/aceeditor/gwt/GwtAceChangeEvent;)(event);
		}
	...
	public final native void addChangeCursorHandler(
		...
		var cb = function(event) {
			handler.@io.jmix.ui.widget.client.addon.aceeditor.gwt.GwtAceChangeCursorHandler::onChangeCursor(Lio/jmix/ui/widget/client/addon/aceeditor/gwt/GwtAceEvent;)(event);
		}
	...
	public final native void addChangeSelectionHandler(
		...
		var cb = function(event) {
			handler.@io.jmix.ui.widget.client.addon.aceeditor.gwt.GwtAceChangeSelectionHandler::onChangeSelection(Lio/jmix/ui/widget/client/addon/aceeditor/gwt/GwtAceEvent;)(event);
		}
	...
	public final native void setKeyboardHandler(GwtAceKeyboardHandler handler) /*-{
		var h = { handleKeyboard: function(data, hashId, keyString, keyCode, e) {
			...
			var command = handler.@io.jmix.ui.widget.client.addon.aceeditor.gwt.GwtAceKeyboardHandler::handleKeyboard(Lcom/google/gwt/core/client/JavaScriptObject;ILjava/lang/String;ILio/jmix/ui/widget/client/addon/aceeditor/gwt/GwtAceKeyboardEvent;)(data, hashId, keyString, keyCode, e);
			if (command===@io.jmix.ui.widget.client.addon.aceeditor.gwt.GwtAceKeyboardHandler$Command::NULL) {
				return {command: "null"};
			}
		}};
	...
	public final native void addFocusListener(GwtAceFocusBlurHandler handler) /*-{
		var focus = function(event) {
			handler.@io.jmix.ui.widget.client.addon.aceeditor.gwt.GwtAceFocusBlurHandler::onFocus(Lio/jmix/ui/widget/client/addon/aceeditor/gwt/GwtAceEvent;)(event);
		}
		var blur = function(event) {
			handler.@io.jmix.ui.widget.client.addon.aceeditor.gwt.GwtAceFocusBlurHandler::onBlur(Lio/jmix/ui/widget/client/addon/aceeditor/gwt/GwtAceEvent;)(event);
		}
