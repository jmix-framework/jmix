...
public class JmixBrowserFrameWidget extends VBrowserFrame {
    ...
    protected void setSrcdoc(String srcdoc, String connectorId) {
        if (srcdoc == null || srcdoc.isEmpty()) {
            ...
            iframe.removeAttribute(JmixBrowserFrameState.SRCDOC);
        } else {
            if (iframe == null) {
                createIFrame(connectorId);
            }
            iframe.setAttribute(JmixBrowserFrameState.SRCDOC, srcdoc);
        }
    }
    ...
    public void setSource(String source) {
        if (source == null) {
            ...
            String srcdoc = iframe.getAttribute(JmixBrowserFrameState.SRCDOC);
            if (srcdoc == null || srcdoc.isEmpty()) {
                removeIFrame();
                return;
            }
