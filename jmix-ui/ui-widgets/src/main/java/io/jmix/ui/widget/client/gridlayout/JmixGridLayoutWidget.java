...
public class JmixGridLayoutWidget extends VGridLayout {

    protected ShortcutActionHandler shortcutHandler;

    public JmixGridLayoutWidget() {
        super();
    ...
    public class JmixGridLayoutCell extends Cell {

        public JmixGridLayoutCell(int row, int col) {
            super(row, col);
        }

        @Override
        protected ComponentConnectorLayoutSlot createComponentConnectorLayoutSlot(ComponentConnector component) {
            return new JmixGridLayoutSlot(VGridLayout.CLASSNAME, component, getConnector());
        }
    }
    ...
    public Cell createNewCell(int row, int col) {
        ...
        Cell cell = new JmixGridLayoutCell(row, col);
        cells[col][row] = cell;
        return cell;
    }
