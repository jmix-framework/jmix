...
public class JmixSideMenuWidget extends FocusableFlowPanel
    ...
    public static class MenuItemWidget extends Widget implements ClickHandler {
        ...
        public MenuItemWidget(JmixSideMenuWidget menu, String id, Icon icon, String styleName,
    ...
    public static class MenuContainerWidget extends FlowPanel {
        ...
        public MenuContainerWidget(JmixSideMenuWidget menu, MenuItemWidget menuItemWidget) {
            this.menu = menu;
