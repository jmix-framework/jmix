...
public class FilterComponentRegistrationBuilder<C extends FilterComponent, M extends FilterCondition> {
     ...
     */
    public static <C extends FilterComponent, M extends FilterCondition> FilterComponentRegistrationBuilder<C, M> create(Class<C> componentClass,
                                                                                                                         Class<M> modelClass,
                                                                                                                         Class<? extends FilterConverter<C, M>> converterClass) {
    ...
    /**
     * Sets an id of the model edit screen. If no identifier is specified then the identifier will be equal
     * to the model name obtained from the {@link JmixEntity}, with {@link Window#EDITOR_WINDOW_SUFFIX}.
     *
     * @param editScreenId id of the model edit screen
     * @return builder instance
     */
    public FilterComponentRegistrationBuilder<C, M> withEditScreenId(String editScreenId) {
    ...
    public FilterComponentRegistration build() {
        return new FilterComponentRegistrationImpl(componentClass, modelClass, converterClass, editScreenId);
    }
}
