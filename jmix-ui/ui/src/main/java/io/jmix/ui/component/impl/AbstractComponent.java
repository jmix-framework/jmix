...
public abstract class AbstractComponent<T extends com.vaadin.ui.Component>
    ...
    public boolean isResponsive() {
        ...
        if (composition instanceof com.vaadin.ui.AbstractComponent) {
            return ((com.vaadin.ui.AbstractComponent) composition).isResponsive();
        }
        return false;
    }
    ...
    public void setResponsive(boolean responsive) {
        ...
        if (composition instanceof com.vaadin.ui.AbstractComponent) {
            ((com.vaadin.ui.AbstractComponent) composition).setResponsive(responsive);
        }
    }
    ...
    public boolean isCaptionAsHtml() {
        return ((com.vaadin.ui.AbstractComponent) component).isCaptionAsHtml();
    }

    @Override
    public void setCaptionAsHtml(boolean captionAsHtml) {
        if (isCaptionAsHtml() != captionAsHtml) {
            ((com.vaadin.ui.AbstractComponent) component).setCaptionAsHtml(captionAsHtml);
    ...
    public void setDescription(@Nullable String description) {
        ...
        ((com.vaadin.ui.AbstractComponent) component).setDescription(description, descriptionAsHtml
    ...
    public SizeUnit getHeightSizeUnit() {
        return WrapperUtils.toSizeUnit(getComposition().getHeightUnits());
    }
    ...
    public SizeUnit getWidthSizeUnit() {
        return WrapperUtils.toSizeUnit(getComposition().getWidthUnits());
    }
        ...
        if (getComposition().getParent() != null) {
            ...
            if (component instanceof Layout.AlignmentHandler) {
                ((Layout.AlignmentHandler) component).setComponentAlignment(this.getComposition(),
                        WrapperUtils.toVaadinAlignment(alignment));
            }
        }
    }
    ...
    public String getContextHelpText() {
        return ((com.vaadin.ui.AbstractComponent) getComposition()).getContextHelpText();
    }
    ...
    public void setContextHelpText(@Nullable String contextHelpText) {
        ...
        ((com.vaadin.ui.AbstractComponent) getComposition()).setContextHelpText(contextHelpText);
    }

    @Override
    public boolean isContextHelpTextHtmlEnabled() {
        return ((com.vaadin.ui.AbstractComponent) getComposition()).isContextHelpTextHtmlEnabled();
    }

    @Override
    public void setContextHelpTextHtmlEnabled(boolean enabled) {
        if (isContextHelpTextHtmlEnabled() != enabled) {
            ((com.vaadin.ui.AbstractComponent) getComposition()).setContextHelpTextHtmlEnabled(enabled);
    ...
    public void setContextHelpIconClickHandler(@Nullable Consumer<ContextHelpIconClickEvent> handler) {
        if (!Objects.equals(this.contextHelpIconClickHandler, handler)) {
            ...
            if (handler == null) {
                ...
                contextHelpIconClickListener = ((com.vaadin.ui.AbstractComponent) getComposition())
    ...
    protected boolean hasValidationError() {
        if (getComposition() instanceof com.vaadin.ui.AbstractComponent) {
            com.vaadin.ui.AbstractComponent composition = (com.vaadin.ui.AbstractComponent) getComposition();
