...
public class JmixEditorSaveEvent<T> extends EditorSaveEvent<T> {
     ...
     */
    public JmixEditorSaveEvent(Editor<T> editor, T bean, Map<Grid.Column<T, ?>, Component> columnFieldMap) {
        super(editor, bean);
