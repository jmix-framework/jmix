...
import io.jmix.localusermanagement.substitution.DatabaseUserSubstitutionProvider
...
class DatabaseUserSubstitutionProviderTest extends LocalUserManagementSpecification {
