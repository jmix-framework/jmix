...
import io.jmix.core.importexport.EntityImportException;
import io.jmix.core.importexport.EntityImportExport;
import io.jmix.core.importexport.EntityImportView;
import io.jmix.core.importexport.EntityImportViewBuilder;
...
//    protected PersistenceManagerClient persistenceManagerClient;
    ...
    protected ResponseInfo createResponseInfoEntity(HttpServletRequest request,
        ...
        if (restProperties.getRestResponseViewEnabled() && responseView != null && !entityStates.isLoadedWithView(entity, responseView)) {
    ...
    protected ResponseInfo createResponseInfoEntities(HttpServletRequest request,
        ...
        if (restProperties.getRestResponseViewEnabled() && responseView != null) {
    ...
    protected Entity getUpdatedEntity(String entityName,
        ...
        try {
            importedEntities = entityImportExport.importEntities(Collections.singletonList(entity),
                    entityImportView, true, restProperties.getOptimisticLockingEnabled());
        } catch (EntityImportException e) {
    ...
    protected String createEntityJson(Entity entity, MetaClass metaClass, String responseView, String version) {
        ...
        String json;
        if (restProperties.getRestResponseViewEnabled()) {
