...
@JmixEntity
@Table(name = "TEST_EMB_TRACK_ROOT_ENTITY")
@Entity
public class TestEmbTrackRootEntity extends BaseEntity {
    @InstanceName
    @Column(name = "NAME")
    private String name;
    ...
    private List<TestEmbTrackRefEntity> references;

    public List<TestEmbTrackRefEntity> getReferences() {
        return references;
    }

    public void setReferences(List<TestEmbTrackRefEntity> references) {
