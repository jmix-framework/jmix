...
import io.jmix.uicharts.component.*;
import io.jmix.uicharts.component.impl.*;
import io.jmix.uicharts.loader.*;
...
public class UiChartsConfiguration {

    @Bean("ui_UiChartsControllers")
    public UiControllersConfiguration screens(ApplicationContext applicationContext,
                                              AnnotationScanMetadataReaderFactory metadataReaderFactory) {
        UiControllersConfiguration uiControllers
                = new UiControllersConfiguration(applicationContext, metadataReaderFactory);
        uiControllers.setBasePackages(Collections.singletonList("io.jmix.uicharts.screen"));
