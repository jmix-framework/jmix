...
import io.jmix.uicharts.component.AngularGaugeChart;
...
public class AngularGaugeChartImpl extends ChartImpl<AngularGaugeChart, io.jmix.uicharts.model.chart.impl.AngularGaugeChart>
        implements AngularGaugeChart {
    @Override
    protected io.jmix.uicharts.model.chart.impl.AngularGaugeChart createChartConfiguration() {
        return new io.jmix.uicharts.model.chart.impl.AngularGaugeChart();
    }
