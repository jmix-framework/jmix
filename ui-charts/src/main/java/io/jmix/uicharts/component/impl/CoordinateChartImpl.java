...
public abstract class CoordinateChartImpl<T extends CoordinateChart,
        M extends io.jmix.uicharts.model.chart.impl.CoordinateChart> extends ChartImpl<T, M> implements CoordinateChart<T> {
    ...
    protected void onAxisZoomListener(io.jmix.uicharts.widget.amcharts.events.axis.AxisZoomEvent e) {
    ...
    protected void onGraphClick(io.jmix.uicharts.widget.amcharts.events.graph.GraphClickEvent e) {
    ...
    protected void onGraphItemClick(io.jmix.uicharts.widget.amcharts.events.graph.GraphItemClickEvent e) {
    ...
    protected void onGraphItemRightClick(io.jmix.uicharts.widget.amcharts.events.graph.GraphItemRightClickEvent e) {
    ...
    protected void onRollOutGraphClick(io.jmix.uicharts.widget.amcharts.events.roll.RollOutGraphEvent e) {
    ...
    protected void onRollOutGraphItemClick(io.jmix.uicharts.widget.amcharts.events.roll.RollOutGraphItemEvent e) {
    ...
    protected void onRollOverGraphClick(io.jmix.uicharts.widget.amcharts.events.roll.RollOverGraphEvent e) {
    ...
    protected void onRollOverGraphItemClick(io.jmix.uicharts.widget.amcharts.events.roll.RollOverGraphItemEvent e) {
