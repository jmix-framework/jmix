...
import io.jmix.uicharts.component.RectangularChart;
import io.jmix.uicharts.model.Color;
import io.jmix.uicharts.model.Scrollbar;
...
public abstract class RectangularChartImpl<T extends RectangularChart, M extends io.jmix.uicharts.model.chart.impl.RectangularChart>
    ...
    protected void setupRectangularChartDefaults(io.jmix.uicharts.model.chart.impl.RectangularChart chart) {
    ...
    protected void onCursorPeriodSelect(io.jmix.uicharts.widget.amcharts.events.cursor.CursorPeriodSelectEvent e) {
    ...
    protected void onCursorZoom(io.jmix.uicharts.widget.amcharts.events.cursor.CursorZoomEvent e) {
