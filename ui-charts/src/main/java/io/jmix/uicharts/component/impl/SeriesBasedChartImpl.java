...
import io.jmix.uicharts.component.SeriesBasedChart;
import io.jmix.uicharts.model.Scrollbar;
import io.jmix.uicharts.model.axis.CategoryAxis;
import io.jmix.uicharts.model.chart.impl.AbstractSerialChart;
import io.jmix.uicharts.model.date.DayOfWeek;
...
public abstract class SeriesBasedChartImpl<T extends SeriesBasedChart, M extends AbstractSerialChart> extends RectangularChartImpl<T, M>
    ...
    protected void onZoomEvent(io.jmix.uicharts.widget.amcharts.events.zoom.ZoomEvent e) {
    ...
    protected void onCategoryItemClick(io.jmix.uicharts.widget.amcharts.events.category.CategoryItemClickEvent e) {
