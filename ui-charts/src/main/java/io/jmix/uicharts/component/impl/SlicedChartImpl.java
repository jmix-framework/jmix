...
import io.jmix.uicharts.component.SlicedChart;
...
public abstract class SlicedChartImpl<T extends SlicedChart,
        M extends io.jmix.uicharts.model.chart.impl.SlicedChart> extends ChartImpl<T, M> implements io.jmix.uicharts.component.SlicedChart<T> {
    ...
    protected void onSliceClick(io.jmix.uicharts.widget.amcharts.events.slice.SliceClickEvent e) {
    ...
    protected void onSliceRightClick(io.jmix.uicharts.widget.amcharts.events.slice.SliceRightClickEvent e) {
    ...
    protected void onSlicePullIn(io.jmix.uicharts.widget.amcharts.events.slice.SlicePullInEvent e) {
    ...
    protected void onSlicePullOut(io.jmix.uicharts.widget.amcharts.events.slice.SlicePullOutEvent e) {
