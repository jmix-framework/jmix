...
import io.jmix.uicharts.ChartLocaleHelper;
import io.jmix.uicharts.component.StockChart;
import io.jmix.uicharts.model.Color;
import io.jmix.uicharts.model.axis.CategoryAxesSettings;
import io.jmix.uicharts.model.axis.ValueAxesSettings;
import io.jmix.uicharts.model.balloon.Balloon;
import io.jmix.uicharts.model.chart.impl.StockChartGroup;
import io.jmix.uicharts.model.chart.impl.StockPanel;
import io.jmix.uicharts.model.dataset.DataSet;
import io.jmix.uicharts.model.dataset.DataSetSelector;
import io.jmix.uicharts.model.date.DatePeriod;
import io.jmix.uicharts.model.export.Export;
import io.jmix.uicharts.model.period.PeriodSelector;
import io.jmix.uicharts.model.period.PeriodType;
import io.jmix.uicharts.model.settings.*;
import io.jmix.uicharts.model.stock.StockEvent;
import io.jmix.uicharts.model.stock.StockEventsSettings;
import io.jmix.uicharts.model.stock.StockGraph;
import io.jmix.uicharts.serialization.JmixStockChartSerializer;
import io.jmix.uicharts.widget.amcharts.JmixAmStockChartScene;
import io.jmix.uicharts.widget.amcharts.JmixAmchartsIntegration;
import io.jmix.uicharts.widget.amcharts.events.dataset.listener.DataSetSelectorCompareListener;
import io.jmix.uicharts.widget.amcharts.events.dataset.listener.DataSetSelectorSelectListener;
import io.jmix.uicharts.widget.amcharts.events.dataset.listener.DataSetSelectorUnCompareListener;
import io.jmix.uicharts.widget.amcharts.events.period.PeriodSelectorChangeListener;
import io.jmix.uicharts.widget.amcharts.events.stock.listener.*;
import io.jmix.uicharts.widget.amcharts.serialization.ChartJsonSerializationContext;
import io.jmix.uicharts.widget.amcharts.serialization.StockChartSerializer;
...
public class StockChartImpl extends AbstractComponent<JmixAmStockChartScene>
    ...
    protected class StockChartEventsForwarder
        ...
        @Override
        public void onClick(io.jmix.uicharts.widget.amcharts.events.stock.StockChartClickEvent e) {
        ...
        @Override
        public void onClick(io.jmix.uicharts.widget.amcharts.events.stock.StockGraphClickEvent e) {
        ...
        @Override
        public void onZoom(io.jmix.uicharts.widget.amcharts.events.stock.StockPanelZoomEvent e) {
        ...
        @Override
        public void onClick(io.jmix.uicharts.widget.amcharts.events.stock.StockEventClickEvent e) {
        ...
        @Override
        public void onRollOut(io.jmix.uicharts.widget.amcharts.events.stock.StockEventRollOutEvent e) {
        ...
        @Override
        public void onRollOut(io.jmix.uicharts.widget.amcharts.events.stock.StockGraphRollOutEvent e) {
            StockPanel stockPanel = getStockPanelById(e.getPanelId());
            StockGraph stockGraph = getStockGraphById(stockPanel, e.getGraphId());
        ...
        @Override
        public void onRollOver(io.jmix.uicharts.widget.amcharts.events.stock.StockEventRollOverEvent e) {
        ...
        @Override
        public void onRollOver(io.jmix.uicharts.widget.amcharts.events.stock.StockGraphRollOverEvent e) {
            StockPanel stockPanel = getStockPanelById(e.getPanelId());
            StockGraph stockGraph = getStockGraphById(stockPanel, e.getGraphId());
        ...
        @Override
        public void onChange(io.jmix.uicharts.widget.amcharts.events.period.PeriodSelectorChangeEvent e) {
        ...
        @Override
        public void onClick(io.jmix.uicharts.widget.amcharts.events.stock.StockChartRightClickEvent e) {
        ...
        @Override
        public void onClick(io.jmix.uicharts.widget.amcharts.events.stock.StockGraphItemClickEvent e) {
            StockPanel stockPanel = getStockPanelById(e.getPanelId());
            StockGraph stockGraph = getStockGraphById(stockPanel, e.getGraphId());
        ...
        @Override
        public void onSelect(io.jmix.uicharts.widget.amcharts.events.dataset.DataSetSelectorSelectEvent e) {
            publish(DataSetSelectorSelectEvent.class,
                    new DataSetSelectorSelectEvent(StockChartImpl.this, e.getDataSetId()));
        }

        @Override
        public void onRollOut(io.jmix.uicharts.widget.amcharts.events.stock.StockGraphItemRollOutEvent e) {
            StockPanel stockPanel = getStockPanelById(e.getPanelId());
            StockGraph stockGraph = getStockGraphById(stockPanel, e.getGraphId());
        ...
        @Override
        public void onCompare(io.jmix.uicharts.widget.amcharts.events.dataset.DataSetSelectorCompareEvent e) {
            publish(DataSetSelectorCompareEvent.class,
                    new DataSetSelectorCompareEvent(StockChartImpl.this, e.getDataSetId()));
        }

        @Override
        public void onRollOver(io.jmix.uicharts.widget.amcharts.events.stock.StockGraphItemRollOverEvent e) {
            StockPanel stockPanel = getStockPanelById(e.getPanelId());
            StockGraph stockGraph = getStockGraphById(stockPanel, e.getGraphId());
        ...
        @Override
        public void onUnCompare(io.jmix.uicharts.widget.amcharts.events.dataset.DataSetSelectorUnCompareEvent e) {
            publish(DataSetSelectorUnCompareEvent.class,
                    new DataSetSelectorUnCompareEvent(StockChartImpl.this, e.getDataSetId()));
        }

        @Override
        public void onClick(io.jmix.uicharts.widget.amcharts.events.stock.StockGraphItemRightClickEvent e) {
            StockPanel stockPanel = getStockPanelById(e.getPanelId());
            StockGraph stockGraph = getStockGraphById(stockPanel, e.getGraphId());
