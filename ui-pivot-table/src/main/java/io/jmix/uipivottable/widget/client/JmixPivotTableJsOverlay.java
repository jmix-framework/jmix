...
package io.jmix.uipivottable.widget.client;

import com.google.gwt.core.client.JavaScriptObject;
import com.google.gwt.dom.client.Element;
import io.jmix.uipivottable.widget.client.events.JsCellClickEvent;
import io.jmix.uipivottable.widget.client.events.JsRefreshEvent;
...
public class JmixPivotTableJsOverlay {
    ...
    protected static native JavaScriptObject makeJsPivotTable(Element placeHolder, JavaScriptObject configObject,
        ...
        if (cellClickHandler) {
            ...
            @io.jmix.uipivottable.widget.client.utils.JsUtils::merge(*)(configObject.options, cfg);
        }
