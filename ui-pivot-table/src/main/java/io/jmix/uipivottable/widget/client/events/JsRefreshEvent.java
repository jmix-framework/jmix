...
package io.jmix.uipivottable.widget.client.events;
...
public class JsRefreshEvent extends JavaScriptObject {
    ...
    public final native String getRenderer() /*-{
        ...
        return @io.jmix.uipivottable.widget.client.utils.JsUtils::getKeyByValue(*)(localeMapping, this.rendererName);
    }-*/;
    ...
    public final native String getAggregation() /*-{
        ...
        if (this.aggregatorsIds) {
            ...
            return @io.jmix.uipivottable.widget.client.utils.JsUtils::getKeyByValue(*)(localeMapping, this.aggregatorName);
        }
    }-*/;
