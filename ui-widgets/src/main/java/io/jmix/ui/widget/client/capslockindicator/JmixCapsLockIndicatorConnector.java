...
@Connect(JmixCapsLockIndicator.class)
public class JmixCapsLockIndicatorConnector extends LabelConnector {

    public JmixCapsLockIndicatorConnector() {
        getWidget().showCapsLockStatus(false); // init caps lock-off status by default
    }

    @Override
    public JmixCapsLockIndicatorWidget getWidget() {
        return (JmixCapsLockIndicatorWidget) super.getWidget();
    }

    @Override
    public JmixCapsLockIndicatorState getState() {
