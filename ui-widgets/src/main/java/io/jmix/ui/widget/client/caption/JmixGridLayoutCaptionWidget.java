...
public class JmixGridLayoutCaptionWidget extends JmixCaptionWidget {

    public static final String INLINE_ICON_CLASSNAME = "v-caption-inline-icon";

    public JmixGridLayoutCaptionWidget(ComponentConnector component, ApplicationConnection client) {
