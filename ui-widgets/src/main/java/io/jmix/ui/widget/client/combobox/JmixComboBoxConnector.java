...
@Connect(value = JmixComboBox.class, loadStyle = Connect.LoadStyle.EAGER)
public class JmixComboBoxConnector extends ComboBoxConnector implements Paintable {

    @Override
    public JmixComboBoxWidget getWidget() {
        return (JmixComboBoxWidget) super.getWidget();
    }
