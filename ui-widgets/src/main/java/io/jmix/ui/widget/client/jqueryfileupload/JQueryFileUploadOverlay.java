...
import static io.jmix.ui.widget.client.jqueryfileupload.JmixFileUploadWidget.JMIX_FILEUPLOAD_DROPZONE_CLASSNAME;
    ...
    */
    ...
    protected native void init(Element fileInput) /*-{
        ...
        upload.bind('fileuploadadd', $entry(function (e, data) {
            data.url = self.@io.jmix.ui.widget.client.jqueryfileupload.JQueryFileUploadOverlay::uploadUrl;

            self.@io.jmix.ui.widget.client.jqueryfileupload.JQueryFileUploadOverlay::addPendingUpload(*)(data);
        }));

        upload.bind('fileuploaddone', $entry(function (e, data) {
            self.@io.jmix.ui.widget.client.jqueryfileupload.JQueryFileUploadOverlay::removePendingUpload(*)(data);
        }));

        upload.bind('fileuploadsend', $entry(function (e, data) {
            self.@io.jmix.ui.widget.client.jqueryfileupload.JQueryFileUploadOverlay::fileUploadStart(*)(data.files[0].name);
        }));

        upload.bind('fileuploadprogress', $entry(function (e, data) {
            self.@io.jmix.ui.widget.client.jqueryfileupload.JQueryFileUploadOverlay::uploadProgress(*)(data.loaded, data.total);
        }));

        upload.bind('fileuploaddone', $entry(function (e, data) {
            self.@io.jmix.ui.widget.client.jqueryfileupload.JQueryFileUploadOverlay::fileUploadSucceed(*)(data.files[0].name);
        }));

        upload.bind('fileuploadstop', $entry(function (e, data) {
            self.@io.jmix.ui.widget.client.jqueryfileupload.JQueryFileUploadOverlay::fileUploadStop()();
        }));

        upload.bind('fileuploadfail', $entry(function (e, data) {
            self.@io.jmix.ui.widget.client.jqueryfileupload.JQueryFileUploadOverlay::uploadFailed(*)(data.textStatus, data.errorThrown);
        }));
    }-*/;
