...
import io.jmix.ui.widget.client.addon.popupbutton.VPopupButton;
    ...
    protected void onPopupOpened() {
        ...
        for (Widget popupChild : getPopup()) {
            if (popupChild instanceof FlowPanel) {
                ...
                for (Widget contentChild : content) {
                    VButton button = null;
                    if (contentChild instanceof JmixFileUploadWidget) {
                        button = ((JmixFileUploadWidget) contentChild).getSubmitButton();
