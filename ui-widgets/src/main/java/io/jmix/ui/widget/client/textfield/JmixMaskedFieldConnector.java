...
@Connect(JmixMaskedTextField.class)
public class JmixMaskedFieldConnector extends TextFieldConnector implements Paintable {

    @Override
    public JmixMaskedTextFieldState getState() {
        return (JmixMaskedTextFieldState) super.getState();
    }

    @Override
    public JmixMaskedFieldWidget getWidget() {
        return (JmixMaskedFieldWidget) super.getWidget();
    }
