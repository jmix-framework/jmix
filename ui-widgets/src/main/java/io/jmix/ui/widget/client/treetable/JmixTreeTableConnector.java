...
@Connect(JmixTreeTable.class)
public class JmixTreeTableConnector extends TreeTableConnector {

    protected static final String HAS_FOOTER_STYLENAME = "has-footer";

    protected HandlerRegistration tooltipHandlerRegistration;

    public JmixTreeTableConnector() {
    ...
    @Override
    public JmixTreeTableWidget getWidget() {
        return (JmixTreeTableWidget) super.getWidget();
    }

    @Override
    public JmixTreeTableState getState() {
        return (JmixTreeTableState) super.getState();
    }
    ...
    public TooltipInfo getTooltipInfo(Element element) {
        ...
        if (element != getWidget().getElement()) {
            Object node = WidgetUtil.findWidget(
                    element,
                    JmixTreeTableWidget.JmixTreeTableBody.JmixTreeTableRow.class);

            if (node != null) {
                JmixTreeTableWidget.JmixTreeTableBody.JmixTreeTableRow row
                        = (JmixTreeTableWidget.JmixTreeTableBody.JmixTreeTableRow) node;
