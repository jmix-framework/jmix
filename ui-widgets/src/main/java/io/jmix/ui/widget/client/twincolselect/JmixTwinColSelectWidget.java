...
public class JmixTwinColSelectWidget extends VTwinColSelect {
    ...
    protected DoubleClickListBox createOptionsBox() {
        return new JmixDoubleClickListBox();
    }
    ...
    protected void updateListBoxItems(ListBox listBox, List<JsonObject> options) {
        List<String> listBoxItems = ((JmixDoubleClickListBox) listBox).getItems();
    ...
    protected void afterUpdatesOptionsBox(List<JsonObject> items) {
        ...
        for (JsonObject item : items) {
            JmixDoubleClickListBox jmixSelections = (JmixDoubleClickListBox) optionsListBox;
            if (item.hasKey("style")) {
                jmixSelections.setOptionClassName(index, item.getString("style"));
            } else {
                jmixSelections.removeClassName(index);
            }
            index++;
        }
    }
    ...
    protected void afterUpdatesSelectionsBox(List<JsonObject> selection) {
        ...
        for (JsonObject item : selection) {
            JmixDoubleClickListBox jmixSelections = (JmixDoubleClickListBox) selectionsListBox;
            if (item.hasKey("style")) {
                jmixSelections.setOptionClassName(index, item.getString("style"));
            } else {
                jmixSelections.removeClassName(index);
    ...
    public class JmixDoubleClickListBox extends DoubleClickListBox {
