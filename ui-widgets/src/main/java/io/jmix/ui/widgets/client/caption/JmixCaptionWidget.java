...
package io.jmix.ui.widgets.client.caption;
...
public class JmixCaptionWidget extends VCaption implements ClickHandler {
    ...
    public JmixCaptionWidget(ComponentConnector component, ApplicationConnection client) {
