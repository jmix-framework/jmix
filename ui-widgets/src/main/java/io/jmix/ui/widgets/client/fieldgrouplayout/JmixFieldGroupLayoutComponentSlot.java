...
import io.jmix.ui.widgets.client.caption.CaptionHolder;
import io.jmix.ui.widgets.client.caption.JmixCaptionWidget;
import io.jmix.ui.widgets.client.gridlayout.JmixGridLayoutSlot;
 ...
 */
public class JmixFieldGroupLayoutComponentSlot extends JmixGridLayoutSlot
    ...
    public JmixFieldGroupLayoutComponentSlot(String baseClassName, ComponentConnector child, ManagedLayout layout) {
    ...
    public void setCaption(VCaption caption) {
        if (!isCaptionInline()) {
            ...
            if (caption instanceof JmixCaptionWidget) {
                moveIndicatorsRight((JmixCaptionWidget) caption);
                ((JmixCaptionWidget) caption).setCaptionHolder(this);
            }
        }
    }
    ...
    protected void moveIndicatorsRight(final JmixCaptionWidget captionWidget) {
