...
import io.jmix.ui.widgets.client.button.JmixButtonWidget;

import javax.annotation.Nullable;

public class JmixGridLayoutSlot extends ComponentConnectorLayoutSlot {

    public JmixGridLayoutSlot(String baseClassName, ComponentConnector child, ManagedLayout layout) {
    ...
    public int getWidgetHeight() {
        ...
        if (widget instanceof JmixButtonWidget) {
            return getButtonHeight((JmixButtonWidget) widget);
        }
