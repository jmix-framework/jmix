...
package io.jmix.ui.widgets.client.label;
...
@Connect(value = JmixLabel.class, loadStyle = Connect.LoadStyle.EAGER)
public class JmixLabelConnector extends LabelConnector {
    ...
    @Override
    public JmixLabelWidget getWidget() {
        return (JmixLabelWidget) super.getWidget();
    }
    ...
    public void onStateChanged(StateChangeEvent stateChangeEvent) {
        ...
        JmixLabelWidget widget = getWidget();
