...
package io.jmix.ui.widgets.client.notification;
...
import static io.jmix.ui.widgets.client.notification.JmixNotificationConnector.JMIX_NOTIFICATION_MODALITY_CURTAIN_CLASSNAME;

public class JmixNotification extends VNotification {
    ...
    public boolean onEventPreview(Event event) {
        ...
        if ((type == Event.ONCLICK || type == Event.ONTOUCHEND)
            ...
            if (containsSubstring(target.getClassName(), JMIX_NOTIFICATION_MODALITY_CURTAIN_CLASSNAME)) {
                hide();
                return false;
            }
        }
