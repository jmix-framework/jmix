...
public class JmixNotificationConnector extends NotificationConnector {
    ...
    protected NotificationDelegate getDelegate() {
        return new JmixNotificationDelegate();
    }

    public class JmixNotificationDelegate implements NotificationDelegate {
        ...
        protected com.google.gwt.user.client.Element getModalityCurtain() {
            if (modalityCurtain == null) {
                ...
                modalityCurtain.setClassName(JMIX_NOTIFICATION_MODALITY_CURTAIN_CLASSNAME);
            }
