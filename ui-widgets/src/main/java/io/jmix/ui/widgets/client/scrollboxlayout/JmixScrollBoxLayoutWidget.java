...
import io.jmix.ui.widgets.client.cssactionslayout.JmixCssActionsLayoutWidget;

import java.util.function.BiConsumer;

public class JmixScrollBoxLayoutWidget extends JmixCssActionsLayoutWidget {
    ...
    protected JmixScrollBoxLayoutWidget() {
    ...
    public void onBrowserEvent(Event event) {
        ...
        if (DOM.eventGetType(event) == Event.ONSCROLL) {
            ...
            if (this.scrollTop != scrollTop || this.scrollLeft != scrollLeft) {
                ...
                if (JmixScrollBoxLayoutState.DEFERRED_MODE.equals(scrollChangeMode)) {
                    updateScrollState();
                } else {
