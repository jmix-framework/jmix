...
import io.jmix.ui.widgets.JmixTableDragSourceExtension;
import io.jmix.ui.widgets.client.tableshared.TableWidget;
import io.jmix.ui.widgets.client.tableshared.TableWidget.AfterBodyUpdateListener;
...
@Connect(JmixTableDragSourceExtension.class)
public class JmixTableDragSourceExtensionConnector extends DragSourceExtensionConnector {
    ...
    protected Map<String, String> createDataTransferData(NativeEvent dragStartEvent) {
        getRpcProxy(JmixTableDragSourceExtensionServerRpc.class)
