...
public class JmixMaskedFieldWidget extends VTextField implements ShortcutActionHandler.ShortcutActionHandlerOwner {
    ...
    protected native void addInputHandler(Element elementID)/*-{
        ...
        var listener = $entry(function (e) {
            temp.@io.jmix.ui.widgets.client.textfield.JmixMaskedFieldWidget::handleInput(*)(e.inputType);
        });
    ...
    public void handleInput(String inputType) {
        ...
        switch (inputType) {
            ...
            default:
                handleCutAndPaste();
                Logger.getLogger("JmixMaskedFieldWidget").log(Level.WARNING, "Unknown inputType: " + inputType);
        }
    }
