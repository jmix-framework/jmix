...
package io.jmix.ui.widgets.client.tooltip;
...
import io.jmix.ui.widgets.client.checkbox.JmixCheckBoxWidget;
import io.jmix.ui.widgets.client.resizabletextarea.JmixResizableTextAreaWrapperWidget;
import com.vaadin.client.*;
import com.vaadin.client.ui.VLabel;

import static io.jmix.ui.widgets.client.caption.JmixCaptionWidget.CONTEXT_HELP_CLASSNAME;

public class JmixTooltip extends VTooltip {
    ...
    public class JmixTooltipEventHandler extends TooltipEventHandler {
        ...
        protected boolean isClassNameExcluded(String className) {
            return JmixResizableTextAreaWrapperWidget.RESIZE_ELEMENT.equals(className);
        }
        ...
        protected TooltipInfo getTooltipFor(Element element) {
            ...
            if (isTooltipElement(element)) {
                ...
                if (!(widget instanceof JmixCheckBoxWidget)
