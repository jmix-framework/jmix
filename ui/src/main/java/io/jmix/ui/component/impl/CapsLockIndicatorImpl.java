...
public class CapsLockIndicatorImpl extends AbstractComponent<JmixCapsLockIndicator> implements CapsLockIndicator {

    public CapsLockIndicatorImpl() {
        component = createComponent();
    }

    protected JmixCapsLockIndicator createComponent() {
        return new JmixCapsLockIndicator();
    }
