...
import io.jmix.ui.component.form.ComponentArea;
...
public class FormImpl extends AbstractComponent<JmixFormLayout> implements Form, UiPermissionAware {
    ...
    public CaptionAlignment getChildrenCaptionAlignment() {
        return WrapperUtils.fromVaadinFieldGroupCaptionAlignment(
    ...
    public void setChildrenCaptionAlignment(CaptionAlignment alignment) {
        component.setColumnCaptionAlignment(
                WrapperUtils.toVaadinFieldGroupCaptionAlignment(alignment));
    }
