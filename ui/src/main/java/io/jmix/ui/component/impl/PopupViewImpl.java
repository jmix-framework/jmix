...
public class PopupViewImpl extends AbstractComponent<JmixPopupView> implements PopupView {
    ...
    protected JmixPopupView createComponent() {
        return new JmixPopupView(new EmptyContent());
    }
    ...
    public void setPopupPosition(@Nullable PopupPosition position) {
        component.setPopupPosition(WrapperUtils.toVaadinPopupPosition(position));
    }

    @Nullable
    @Override
    public PopupPosition getPopupPosition() {
        return WrapperUtils.fromVaadinPopupPosition(component.getPopupPosition());
    }
