...
public class WebResponsiveGridLayout extends WebAbstractComponent<JmixResponsiveGridLayout>
    ...
    public WebResponsiveGridLayout() {
    ...
    protected static class RowImpl extends AbstractGridElementImpl<JmixResponsiveGridLayout.Row>
        ...
        public RowImpl(JmixResponsiveGridLayout.Row row, WebResponsiveGridLayout owner) {
            super(row, owner);
        }
        ...
        public SizeUnit getHeightSizeUnit() {
            return WebWrapperUtils.toSizeUnit(getVaadinGridElement().getHeightUnits());
        }
    ...
    protected static class ColumnImpl extends AbstractGridElementImpl<JmixResponsiveGridLayout.Column>
        ...
        public ColumnImpl(JmixResponsiveGridLayout.Column column, WebResponsiveGridLayout owner) {
            super(column, owner);
        }
    ...
    protected static abstract class AbstractGridElementImpl<T extends JmixResponsiveGridLayout.AbstractGridElement>
        ...
        protected WebResponsiveGridLayout owner;

        protected String id;

        public AbstractGridElementImpl(T gridElement, WebResponsiveGridLayout owner) {
        ...
        public WebResponsiveGridLayout getOwner() {
            return owner;
        }
