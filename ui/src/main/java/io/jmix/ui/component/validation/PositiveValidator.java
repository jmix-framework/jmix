 ...
 * for example:
 * <pre>
 *     &lt;bean id="ui_PositiveValidator" class="io.jmix.ui.component.validation.PositiveValidator" scope="prototype"/&gt;
 *     </pre>
*
...
public class PositiveValidator<T extends Number> extends AbstractValidator<T> {
    ...
    public static final String NAME = "ui_PositiveValidator";
