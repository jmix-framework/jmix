...
import static io.jmix.ui.components.HtmlAttributes.CSS;

public abstract class WebWindow implements Window, Component.Wrapper, Component.HasXmlDescriptor,
    ...
    public io.jmix.ui.components.MarginInfo getMargin() {
        if (getContainer() instanceof Layout.MarginHandler) {
            ...
            return new io.jmix.ui.components.MarginInfo(vMargin.hasTop(), vMargin.hasRight(), vMargin.hasBottom(), vMargin.hasLeft());
        }
        return new io.jmix.ui.components.MarginInfo(false);
    }
