 ...
 * for example:
 * <pre>
 *    &lt;bean id="jmix_FutureOrPresentValidator" class="io.jmix.ui.components.validation.FutureOrPresentValidator" scope="prototype"/&gt;
 *    </pre>
...
public class FutureOrPresentValidator<T> extends AbstractValidator<T> {
    ...
    public static final String NAME = "jmix_FutureOrPresentValidator";
