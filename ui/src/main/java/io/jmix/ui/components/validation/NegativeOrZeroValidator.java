 ...
 * for example:
 * <pre>
 *    &lt;bean id="jmix_NegativeOrZeroValidator" class="io.jmix.ui.components.validation.NegativeOrZeroValidator" scope="prototype"/&gt;
 *    </pre>
...
public class NegativeOrZeroValidator<T extends Number> extends AbstractValidator<T> {
    ...
    public static final String NAME = "jmix_NegativeOrZeroValidator";
