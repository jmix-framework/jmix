...
public class WebUiComponents implements UiComponents {
...

    {
        ...
        classes.put(MultiSelectList.NAME, WebMultiSelectList.class);
        classes.put(SingleSelectList.NAME, WebSingleSelectList.class);
...
//        classes.put(Filter.NAME, WebFilter.class); // todo filter
        ...
        classes.put(Drawer.NAME, WebDrawer.class);
