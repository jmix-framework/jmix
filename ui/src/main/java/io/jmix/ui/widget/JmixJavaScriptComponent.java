...
import io.jmix.ui.widget.client.javascriptcomponent.JmixJavaScriptComponentState;
import io.jmix.ui.widget.serialization.DateJsonSerializer;
...
public class JmixJavaScriptComponent extends AbstractJavaScriptComponent implements HasDependencies {
    ...
    protected JmixJavaScriptComponentState getState(boolean markAsDirty) {
        return (JmixJavaScriptComponentState) super.getState(markAsDirty);
    }
