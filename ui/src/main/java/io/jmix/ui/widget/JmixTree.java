...
public class JmixTree<T> extends Tree<T> implements Action.ShortcutNotifier {
    ...
    public void setJTestId(String jmixId) {
        super.setJTestId(jmixId);

        getCompositionRoot().setJTestId(jmixId);
    }

    @Override
    public void setId(String id) {
        debugId = "jmixTree_" + id;
    }
    ...
    public JmixTreeGrid<T> getCompositionRoot() {
        return (JmixTreeGrid<T>) super.getCompositionRoot();
    }
    ...
    public void setDataProvider(DataProvider<T, ?> dataProvider) {
        if (!(dataProvider instanceof EnhancedTreeDataProvider)) {
            throw new IllegalArgumentException("DataProvider must implement " +
                    "io.jmix.ui.widget.tree.EnhancedTreeDataProvider");
        }
