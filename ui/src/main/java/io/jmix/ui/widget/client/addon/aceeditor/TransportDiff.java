...
public class TransportDiff implements Serializable {
	...
	public static class TransportMarkerAddition implements Serializable {
		...
		public TransportMarkerAddition(TransportDoc.TransportMarker marker, String startContext, String endContext) {
			this.marker = marker;
	...
	public static class TransportSetDiffForMarkerAnnotations implements Serializable {
		...
		public TransportSetDiffForMarkerAnnotations(Set<TransportDoc.TransportMarkerAnnotation> added, Set<TransportDoc.TransportMarkerAnnotation> removed) {
			this.added = added;
			this.removed = removed;
		}
		@Override
