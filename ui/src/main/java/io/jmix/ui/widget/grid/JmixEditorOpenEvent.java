...
public class JmixEditorOpenEvent<T> extends EditorOpenEvent<T> {
     ...
     */
    public JmixEditorOpenEvent(Editor<T> editor, T bean, Map<Grid.Column<T, ?>, Component> columnFieldMap) {
        super(editor, bean);
