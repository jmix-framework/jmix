...
import io.jmix.ui.widgets.client.calendar.JmixCalendarEventId;
import io.jmix.ui.widgets.client.calendar.JmixCalendarServerRpc;
...
public class JmixCalendar extends Calendar {
    ...
    public JmixCalendar() {
        ...
        registerRpc(new JmixCalendarServerRpc() {
            @Override
    ...
    public void setDayClickHandler(DayClickHandler dayClickHandler) {
        setHandler(JmixCalendarEventId.DAYCLICK,
                JmixCalendarDayClickEvent.class,
                dayClickHandler,
    ...
    public interface DayClickHandler extends EventListener {
        ...
        void onDayClick(JmixCalendarDayClickEvent event);
    }

    public static class JmixCalendarDayClickEvent extends EventObject {

        protected Date date;

        public JmixCalendarDayClickEvent(Calendar calendar, Date date) {
            super(calendar);
