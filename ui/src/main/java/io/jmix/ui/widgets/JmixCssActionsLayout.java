...
import io.jmix.ui.widgets.client.cssactionslayout.JmixCssActionsLayoutState;
 ...
 */
public class JmixCssActionsLayout extends CssLayout implements Action.Container, LegacyComponent,
        Layout.MarginHandler, Layout.SpacingHandler {
    protected ActionManager actionManager;

    @Override
    protected JmixCssActionsLayoutState getState() {
