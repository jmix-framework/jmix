...
import io.jmix.ui.widgets.client.timefield.JmixTimeFieldState;
...
public class JmixTimeField extends AbstractField<LocalTime> {
    ...
    protected final class AbstractTextFieldFocusAndBlurRpcImpl implements FieldRpc.FocusAndBlurServerRpc {
        ...
        @Override
        public void blur() {
            fireEvent(new FieldEvents.BlurEvent(JmixTimeField.this));
        }

        @Override
        public void focus() {
            fireEvent(new FieldEvents.FocusEvent(JmixTimeField.this));
        }
    }
    ...
    @Override
    protected JmixTimeFieldState getState(boolean markAsDirty) {
        return (JmixTimeFieldState) super.getState(markAsDirty);
    }
