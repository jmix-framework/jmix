...
import io.jmix.ui.widgets.client.treetable.JmixTreeTableState;
...
public class JmixTreeTable extends com.vaadin.v7.ui.TreeTable implements TreeTableContainer, JmixEnhancedTable {
    ...
    @Override
    protected JmixTreeTableState getState() {
        return (JmixTreeTableState) super.getState();
    }

    @Override
    protected JmixTreeTableState getState(boolean markAsDirty) {
        return (JmixTreeTableState) super.getState(markAsDirty);
    }
    ...
    public void setContainerDataSource(Container newDataSource) {
        ...
        if (newDataSource == null || newDataSource instanceof IndexedContainer) { // if it is just created
            ...
            throw new IllegalArgumentException("JmixTreeTable supports only Container.Hierarchical");
        }
    ...
    public Iterator<Component> iterator() {
        ...
        JmixTreeTableState tableState = getState(false);
