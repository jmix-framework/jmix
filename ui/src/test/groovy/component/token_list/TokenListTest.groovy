...
package component.token_list

import com.google.common.collect.Lists
import component.token_list.screen.TokenListTestScreen
...
class TokenListTest extends ScreenSpecification {
    ...
    @Override
    void setup() {
        exportScreensPackages(["component.token_list"])
