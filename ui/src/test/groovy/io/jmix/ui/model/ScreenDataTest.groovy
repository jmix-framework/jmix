...
import io.jmix.ui.test.entity.sales.Product
import io.jmix.ui.test.entity.sales.ProductTag
        ...
        def xml = '''
            <data>
                <instance id="userCont"
                          class="io.jmix.ui.test.entity.sec.User" view="user.edit"/>
                
                <collection id="usersCont"
                            class="io.jmix.ui.test.entity.sec.User" view="user.browse"/>
            </data>
            '''
        ...
        def xml = '''
            <data>
                <instance id="orderCont"
                          class="io.jmix.ui.test.entity.sales.Order">
    ...
    def "containers in fragments"() {
        ...
        def xml = '''
            <data>
                ...
                <collection id="ordersCont" class="io.jmix.ui.test.entity.sales.Order" view="_local">
                    <loader id="ordersLd"/>
                </collection>
            </data>
            '''
        ...
        def xmlA = '''
            <data>
                ...
                <collection id="tagsCont" class="io.jmix.ui.test.entity.sales.ProductTag" view="_local"/>
                
                <instance id="orderContA" class="io.jmix.ui.test.entity.sales.Order">
