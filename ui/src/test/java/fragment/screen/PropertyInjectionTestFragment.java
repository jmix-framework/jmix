...
@UiController("test_PropertyInjectionTestFragment")
@UiDescriptor("property-injection-test-fragment.xml")
public class PropertyInjectionTestFragment extends ScreenFragment {
